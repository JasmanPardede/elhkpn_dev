...
<div class="login-box">
    ...
    <div class="login-box-body" style="border-radius: 5px;">
        Silahkan memasukan password baru!
        <div id="wrapperFormEdit">
            <form class="form-horizontal" method="post" id="ajaxFormPassword" action="<?php echo base_url().'index.php/auth/newPassword'; ?>">
...
<script language="javascript">
    $(document).ready(function () {
        ...
        $("#ajaxFormPassword").submit(function () {
            ...
            token = $('#token').val();
            $.post("<?php echo base_url();?>index.php/auth/newPassword", {
