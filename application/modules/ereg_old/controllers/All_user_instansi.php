...
//        $currpage_found = $curr_page + 1;
    ...
    function load_data_index(){
        ...
        $query = $this->muser->get_list_userpokja_two($this->instansi, $currentpage, $keyword, $rowperpage, true);
        $queryCount = $this->muser->get_list_userpokja_two($this->instansi, $currentpage, $keyword, $rowperpage, false);
