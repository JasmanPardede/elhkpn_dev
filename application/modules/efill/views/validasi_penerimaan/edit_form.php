                ...
                <div class="contentTab">
                    <div class="col-sm-12">
                        <div class="form-group">
                            <div class="row">
                                <div class="col-sm-5">
                                    <label class="control-label">Tanggal Pelaporan <span class="red-label">*</span>:</label>
                                </div>
                                <div class="col-sm-7">
                                    <input required class="col-sm-3 form-control date-picker" type='text' name='TANGGAL_PELAPORAN' id='TANGGAL_PELAPORAN' placeholder='DD/MM/YYYY' value="<?php echo date('d/m/Y', strtotime($item->TANGGAL_PELAPORAN)); ?>" />
                                </div>
                            </div>
                            <input required class="col-sm-3 form-control date-picker" type='hidden' name='TANGGAL_PENERIMAAN' id='TANGGAL_PENERIMAAN' placeholder='DD/MM/YYYY' value="<?php echo date('d/m/Y', strtotime($item->TANGGAL_PENERIMAAN)); ?>" />
                        </div>
                    </div>
                </div>
                <br>
