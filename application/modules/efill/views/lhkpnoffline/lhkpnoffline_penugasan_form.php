...
<div id="wrapperFormEdit" class="form-horizontal">
    <form method="post" id="ajaxFormEdit" action="<?php echo $urlSave;?>">
        <div class="box-body">
            ...
            <div class="form-group">
                <label class="col-sm-4 control-label date-picker">Tanggal Penugasan <font color='red'>*</font>:</label>
                <div class="col-sm-8">
                    <input type='text' class="form-control" name='TANGGAL_PENUGASAN' id='TANGGAL_PENUGASAN' placeholder='DD/MM/YYYY' value='<?php echo date('d/m/Y',strtotime($item->TANGGAL_PENUGASAN));?>' required>
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-4 control-label date-picker">Due Date <font color='red'>*</font>:</label>
                <div class="col-sm-8">
                    <input type='text' class="form-control" name='DUE_DATE' id='DUE_DATE' placeholder='DD/MM/YYYY' value='<?php echo date('d/m/Y',strtotime($item->DUE_DATE));?>'  required>
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-4" style="text-align:right !important;">Keterangan :</label>
                <label class="col-sm-8">
                    <textarea name="KETERANGAN" style="width: 100%"><?php echo $item->KETERANGAN;?></textarea>
                </label>
            </div>            
        </div>      
        <div class="pull-right">
    ...
    <form method="post" id="ajaxFormEdit" action="<?php echo $urlSave;?>">
        <div class="box-body">
            <div class="form-group">
                <label class="col-sm-4 control-label">Assign to <font color='red'>*</font>:</label>
                <div class="col-sm-8">
                    <input type='text' style="width:100%;" name='USERNAME' id='PETUGAS' required>
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-4 control-label">Tanggal Penugasan <font color='red'>*</font>:</label>
            ...
            <div class="form-group">
                <label class="col-sm-4 control-label">Due Date <font color='red'>*</font>:</label>
                <div class="col-sm-8">
                    <input type='text' class="form-control date-picker" name='DUE_DATE' id='DUE_DATE' placeholder='DD/MM/YYYY' value="<?php echo date('d/m/Y');?>" required>
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-4" style="text-align:right !important;">Keterangan :</label>
