                            ...
                            <div class="box-body">
                                <div class="row">
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label">CS / Penerima :</label>
                ...
                <table id="dt_completeNEW" class="table table-striped table-bordered table-hover table-heading no-border-bottom">
						...
						<tbody>
							...
							foreach ($items as $item) {
								...
								?>
							<tr>
								<?php if($item->IS_DITERIMA_KOORD_CS == '1') { ?>
									<td><input class="chk" type="checkbox" <?php echo (in_array($item->ID_PENERIMAAN, $aId) ? 'checked="checked"' : '') ?> value="<?php echo $item->ID_PENERIMAAN ?>" onclick="chk(this);" /> </td>
								<?php } else { ?>
									<td></td>
								<?php } ?>
								<td><?php echo ++$i; ?>.</td>
								...
								<td>
									<table style="background: transparent;">
										<tbody>
                                            ...
                                            <tr>
                                                <th style="vertical-align: top;">Agenda</th>
                                                <td style="vertical-align: top;"><span style="margin-right: 10px;">:</span></td>
                                                <td>
                                                    <?=$agenda;?>
                                                </td>
                                ...
                                <td>
                                    <?php if($item->IS_DITERIMA_KOORD_CS == '0') { ?>
                                        Belum
                                    <?php } else { ?>
                                        Sudah (<?=date('d/m/Y',strtotime($item->TGL_BAST_KOORD_CS))?>)
                                    <?php } ?>
                                </td>
                                <td>
                                    <?php if($item->IS_DITERIMA_KOORD_CS == '0') { ?>
                                        <form method="post" class="ajaxFormAdd2" action="index.php/efill/lhkpnoffline/save/bast">
...
<!--                                             <button type="button" class="btn btn-sm btn-default btn-print" href="<?php echo $urlEdit.'/'.$item->ID_PENERIMAAN.'/printitem'; ?>" title="Terima">
                    ...
                    <form style="margin-top: 20px;" method="post" class='form-horizontal' id="ajaxFormAdd" action="index.php/efill/lhkpnoffline/save/bast">
