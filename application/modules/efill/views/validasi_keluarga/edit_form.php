...
<div id="wrapperFormEdit">
    <form role="form" id="ajaxFormEdit" action="index.php/efill/validasi_keluarga/<?php echo $action; ?>" >
        <div class="modal-body row">
            <div class="col-sm-6">
                ...
                <div class="form-group hubungan">
                    ...
                    if ($xver == '1.8' || $xver == '1.11' || $xver == '1.6' || $xver == '2.1') {
                        $versi = $xver;
                    }
            ...
            <div class="col-sm-6">
                <div class="form-group jenis_kelamin">
                    ...
                    <select class="form-control" id="jenis_kelamin" name="JENIS_KELAMIN" required>
                        <option></option>
                        <option value="LAKI-LAKI" <?php echo !$onAdd && $item->JENIS_KELAMIN == '1' ||  $item->JENIS_KELAMIN == '2' ? 'selected' : ''; ?>>LAKI-LAKI</option>
                        <option value="PEREMPUAN" <?php echo !$onAdd && $item->JENIS_KELAMIN == '3' ? 'selected' : ''; ?>>PEREMPUAN</option>
                    </select>
                </div>
                <div class="form-group">
