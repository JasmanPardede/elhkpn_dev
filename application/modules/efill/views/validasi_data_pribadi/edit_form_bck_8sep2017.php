                    ...
                    <div class="modal-body row">
                        <div class="col-sm-7">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    <div class="input-group row">
                                        <div class="col-xs-2">
                                            <input  class="form-control" type="text" placeholder="Dr."  size='10' name="GELAR_DEPAN" value="<?php echo $item->GELAR_DEPAN ?>">
                                        </div>
                                        <div class="col-xs-8">
                                        ...
                                        <div class="col-xs-2">
                                            <input  class="form-control" type="text" placeholder=",SH"  size='10' name="GELAR_BELAKANG" value="<?php echo $item->GELAR_BELAKANG ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <select id="slcAgama" name="ID_AGAMA" class="form-control" required>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label">No. Tel. Rumah <span class="red-label">*</span>:</label>
                                <div class="col-sm-5">
                                    <input required class="form-control" type='text' name='TELPON_RUMAH' id='TELPON_RUMAH' placeholder="TELPON RUMAH" value='<?php echo $item->TELPON_RUMAH; ?>'>
                                </div>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            ...
                            <div class="form-group">
                                ...
                                <!--<label class="col-sm-3 control-label">Lembaga: </label>-->
                                <input  type='text' id='lembaga' style='width: 60%;' name='LEMBAGA'  class='select2' value='<?php echo !is_null($item_data_jabatan) ? $item_data_jabatan->LEMBAGA : ""; ?>' />
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">Unit Kerja : </label>
                                <!--<label class="col-sm-3 control-label">Unit Kerja: </label>-->
                                <input type='text' id='uk' style='width: 60%;' name='UNIT_KERJA'   class='select2' value='<?php echo !is_null($item_data_jabatan) ? $item_data_jabatan->UK_ID : ""; ?>' />
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="ALAMAT_KANTOR" id="alamat_kantor" rows="2"> <?php echo !is_null($item_data_jabatan) ? $item_data_jabatan->ALAMAT_KANTOR : ""; ?></textarea>
                            </div>
                        </div>
                    </div>
                </div>
