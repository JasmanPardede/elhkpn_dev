...
class Mimplhkpntolhkpn extends CI_Model {
    ...
    public function copy_to_lhkpn($id_imp_xl_lhkpn) {

        $id_lhkpn = $this->copy_to_t_lhkpn($id_imp_xl_lhkpn);
...
//                . "where id_imp_xl_lhkpn = '" . $id_imp_xl_lhkpn . "')";
    ...
    private function get_tanggal_pelaporan($id_imp_xl_lhkpn){
        $this->db->where('id_imp_xl_lhkpn', $id_imp_xl_lhkpn);
        $data = $this->db->get('t_lhkpnoffline_penerimaan');
        return $data->row()->TAHUN_PELAPORAN;
    }

    private function copy_to_t_lhkpn($id_imp_xl_lhkpn) {
        ...
        $record_found = $this->mglobal->get_by_id("t_imp_xl_lhkpn", "t_imp_xl_lhkpn.id_imp_xl_lhkpn", $id_imp_xl_lhkpn, 'array');
        ...
        if ($record_found) {
            ...
            if($record_found['jenis_laporan'] == '4'){
                $record_found['tgl_lapor'] = $this->get_tanggal_pelaporan($id_imp_xl_lhkpn).'-12-30'; 
            }
