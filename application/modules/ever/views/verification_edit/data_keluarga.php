...
<div id="wrapperFormEdit">
    <form role="form" id="ajaxFormEdit" action="index.php/ever/verification_edit/update_keluarga/<?php echo $mode; ?>" >
        <div class="modal-body row">
            <div class="col-sm-6">
                <div class="form-group">
                    <label>NIK </label>
                    <input onkeypress="return isNumber(event);" type="text" name="NIK" id="NIK" class="form-control input_capital" value="<?php echo $keluarga->NIK; ?>" />
                </div>
                <div class="form-group">
                    <?php if (!$onAdd): ?>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        url = url.split('?')[0] + '?upperli=li3&bottomli=0';
