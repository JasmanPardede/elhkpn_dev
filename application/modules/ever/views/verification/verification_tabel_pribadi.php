...
<div class="box-header with-border portlet-header title-pribadi">
    ...
    <?php if ($item->entry_via == '1'): ?>
        <div class="pull-right">
            <button class="btn btn-warning" id="verifEditDataPribadi" href="index.php/ever/verification_edit/index/<?php echo $item->ID_LHKPN;?>"><span class="fa fa-edit"></span> Edit Data Pribadi</button>
        </div>
    <?php endif ?>
</div>
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 div-pribadi-luar">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <div class='col-sm-12 control-label labelisi'>
                    <?php
                    if (@$DATA_PRIBADI->TELPON_RUMAH != '') {
                        echo @$DATA_PRIBADI->TELPON_RUMAH;
                    } else {
                        echo $LHKPN->NO_HP;
                    }
                    ?>
...
<script type="text/javascript">
    $(document).ready(function() {
        $("#verifEditDataPribadi").click(function() {
            url = $(this).attr('href');
            $('#loader_area').show();
            $.post(url, function (html) {
                OpenModalBox('Verifikasi Data Pribadi', html, null, 'large');
            });            
            return false;
        });
    });
