...
<div class="box-header with-border portlet-header title-alat">
    ...
    <span class="pull-right">
        <button class="btn btn-warning" id="verifEditPengeluaran" href="index.php/ever/verification_edit/update_pengeluaran/<?php echo $item->ID_LHKPN;?>"><span class="fa fa-edit"></span> Edit Data</button>
    </span>
</div>
        ...
        <div style="width: 100%;">
            <div class="tab-content">
                    ...
                    <div class="tab-pane <?= ($i == 0) ? 'active' : ''; ?>" id="tabs3<?= $label[$i] ?>">
                        ...
                        <table class="table table-bordered table-hover">
                            <thead class="table-header">
                                <tr>
                                    <th width="40px">NO</th>
                                    <th width="60%">JENIS PENGELUARAN</th>
                                    <?php
                ...
                <div class="row">
                    ...
                    <div class="col-md-4" style="border-radius:5px;padding:5px;background-color:#F39C12;color:#fff;" name="TERBILANG_total2A" id="TERBILANG_total2A" ></div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-4" style="border-radius:5px;padding:5px;background-color:#F39C12;color:#fff;" name="TERBILANG_total2B" id="TERBILANG_total2B" ></div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-4" style="border-radius:5px;padding:5px;background-color:#F39C12;color:#fff;" name="TERBILANG_total2C" id="TERBILANG_total2C" ></div>
                </div>
                <div class="row">
                    <div class="col-md-4" style="padding:5px 15px"><b>TOTAL PENGELUARAN (A + B + C)</b></div>
                    <div class="col-md-1" style="padding:5px 15px"><b>Rp.</b></div>
                    <div class="col-md-3 text-right" style="padding:5px 15px">
                        <b><span id="total2Z" class="total_semua_penerimaan3">
                            <?php
                            echo number_format(@$jpA+@$jpB+@$jpC, 0, ",", ".");
                            ?>
                        </span></b>
                    </div>
                    <div class="col-md-4" style="border-radius:5px;padding:5px;background-color:#F39C12;color:#fff;" name="TERBILANG_total2Z" id="TERBILANG_total2Z" ></div>
                </div>
                <!--<table>
                    <tbody>
                        <tr>
                            ...
                            <td>&nbsp; &nbsp;</td>
                            <td name="TERBILANG_total2A" id="TERBILANG_total2A" style="border-radius:5px;padding:5px;background-color:#F39C12;color:#fff;);"></td>
                        </tr>
                        <tr>
                            ...
                            <td>&nbsp; &nbsp;</td>
                            <td name="TERBILANG_total2B" id="TERBILANG_total2B" style="border-radius:5px;padding:5px;background-color:#F39C12;color:#fff;"></td>
                        </tr>
                        <tr>
                            ...
                            <td>&nbsp; &nbsp;</td>
                            <td name="TERBILANG_total2C" id="TERBILANG_total2C" style="border-radius:5px;padding:5px;background-color:#F39C12;color:#fff;;"></td>
                        </tr>
                        <tr>
                            <td><b>TOTAL PENGELUARAN  (A + B + C)</b></td>
                            <td>&nbsp; = &nbsp;</td>
                            <td align="right"><b>
                                    Rp. <span id="total2Z" class="total_semua_penerimaan3">
                                        <?php
                                        echo number_format(@$jpA + $jpB + $jpC, 0, ",", ".");
                                        ?>
                                    </span>
                            ...
                            <td>&nbsp; &nbsp;</td>
                            <td name="TERBILANG_total2Z" id="TERBILANG_total2Z" style="border-radius:5px;padding:5px;background-color:#F39C12;color:#fff;;"></td>
                        </tr>
                    </tbody>
                </table>-->
            </div>
                ...
                foreach ($total as $key => $value) {
                    ...
                    <!--Total <?= $key ?> : Rp. <?php echo number_format($subjum, 0, ",", "."); ?><br>-->
                     <div class="row">
                        ...
                        <div class="col-md-1" style="padding:5px 15px">Rp.</div>
                        <div class="col-md-3 text-right" id="PENGELUARAN_<?php echo $n; ?>" style="padding:5px 15px"><?php echo number_format($subjum, 0, ",", "."); ?></div>
                        <div class="col-md-4" id="TERBILANG_PENGELUARAN_<?php echo $n; ?>" style="border-radius:5px;padding:5px;background-color:#F39C12;color:#fff;"></div>
                    </div>
                    <?php
                }

                $total_dari_pengeluaran = $totALL;
                ?>
            </div>
            <!--<b>TOTAL PENERIMAAN  (A + B + C)</b> <b>Rp. <span class="total_semua_penerimaan2"><?php echo number_format($totALL, 0, ",", "."); ?></span></b>-->
            <div class="row">
                        <div class="col-md-4" style="padding:5px 15px"><b>TOTAL PENGELUARAN  (A + B + C)</b> </b></div>
                        <div class="col-md-1" style="padding:5px 15px"><b>Rp.</b></div>
                        <div class="col-md-3 text-right" id="PENGELUARAN_TOTAL" style="padding:5px 15px"><b><span class="total_semua_penerimaan2"><?php echo number_format($totALL, 0, ",", "."); ?></span></b></div>
                        <div class="col-md-4" id="TERBILANG_PENGELUARAN_TOTAL" style="border-radius:5px;padding:5px;background-color:#F39C12;color:#fff;"></div>
                    </div>
            <hr>
        </div>
    </form>
...
<div class="aksi">
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <textarea class="msgVer" <?php if($LHKPN->STATUS==2){ ?> disabled <?php } ?> style="width: 100%;"><?php echo @$tmpData->MSG->PENGELUARANKAS; ?></textarea>
    </div>
...
<script type="text/javascript">
    $(document).ready(function() {
    	  $("#verifEditPengeluaran").click(function() {
              url = $(this).attr('href');
              $('#loader_area').show();
              $.post(url, function (html) {
    ...
    showFieldEver('#total2A','#TERBILANG_');
    showFieldEver('#total2B','#TERBILANG_');
    showFieldEver('#total2C','#TERBILANG_');
    showFieldEver('#total2Z','#TERBILANG_');
    showFieldEver('#PENGELUARAN_0','#TERBILANG_');
    showFieldEver('#PENGELUARAN_1','#TERBILANG_');
    showFieldEver('#PENGELUARAN_2','#TERBILANG_');
    showFieldEver('#PENGELUARAN_TOTAL','#TERBILANG_');
