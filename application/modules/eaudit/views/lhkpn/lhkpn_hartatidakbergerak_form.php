...
<div id="wrapperFormAdd">
    <form class='form-horizontal' method="post" id="ajaxFormAddtidakbergerak" action="index.php/eaudit/lhkpn_klarifikasi/savehartatidakbergerak" enctype="multipart/form-data">
        <div class="con-body">
            <div class="box-body">
                <div class="col-sm-6">
            ...
            if(conf) {
                ...
                $.post(url, data, function (res) {
                    ...
                    ng.LoadAjaxTabContent({
                        url: 'index.php/eaudit/lhkpn_klarifikasi/showTable/4/' + ID + '/edit',
                        block: '#block',
                        container: $('#hartatidakbergerak').find('.contentTab')
                    });
                    ng.LoadAjaxTabContent({
                        url: 'index.php/eaudit/lhkpn_klarifikasi/showTable/1/' + ID + '/edit',
                        block: '#block',
                        container: $('#final').find('.contentTab')
                    });
                    ng.LoadAjaxTabContent({
                        url: 'index.php/eaudit/lhkpn_klarifikasi/showTable/19/' + ID + '/edit',
                        block: '#block',
    ...
    function f_kembali_conf()
    {
        $('#pelepasan-con').slideUp('slow', function () {
         ...
         $('input[name="PROV"]').select2({
             ...
             ajax: {
                 url: "<?=base_url('index.php/eaudit/lhkpn_klarifikasi/getProvinsiNew')?>",
                 dataType: 'json',
                 quietMillis: 250,
             ...
             initSelection: function(element, callback) {
                 var id = $(element).val();
                 if (id !== "") {
                     $.ajax("<?=base_url('index.php/eaudit/lhkpn_klarifikasi/getProvinsiNew')?>/"+id, {
                         dataType: "json"
        ...
        $('input[name="PROV"]').on("change", function (e) {
         ...
         $('input[name="KAB_KOT"]').select2({
             minimumInputLength: 0,
             ajax: {
                 url: "<?=base_url('index.php/eaudit/lhkpn_klarifikasi/getKabupaten')?>",
                 dataType: 'json',
                 quietMillis: 250,
                 data: function (term, page) {
                     return {
             ...
             initSelection: function(element, callback) {
                 var id = $(element).val();
                 if (id !== "") {
                     $.ajax("<?=base_url('index.php/eaudit/lhkpn_klarifikasi/getKabupaten')?>/"+prov+'/'+id, {
                         dataType: "json"
                     }).done(function(data) { callback(data[0]); });
                 }
             },
                ...
                <div class="col-md-5">
                 ...
                 <!--    <div class="form-group">
                  ...
                  <!--  </div>
					...
					<div class="form-group">
                        <label>Nilai Hasil Klarifikasi (Rp) <span class="red-label">*</span> </label><?= FormHelpPopOver('nilai_estimasi_pelaporan_htb'); ?>                      
                            <input  required type="text"  name='HASIL_KLARIFIKASI' id='HASIL_KLARIFIKASI' class="form-control int" value="<?php echo $item->HASIL_KLARIFIKASI;?>" placeholder="Hasil Klarifikasi">
    ...
    $(document).ready(function() {
        ...
        $("#ajaxFormEdithartatidakbergerak").submit(function(){
            ...
            $.post(url, data, function(res){
                 ...
                 CloseModalBox();
                 var ID = $('#idLhkpn').val();
                 ng.LoadAjaxTabContent({url:'index.php/eaudit/lhkpn_klarifikasi/showTable/4/'+ID + '/edit', block:'#block', container:$('#hartatidakbergerak').find('.contentTab')});
                 ng.LoadAjaxTabContent({url:'index.php/eaudit/lhkpn_klarifikasi/showTable/1/'+ID + '/edit', block:'#block', container:$('#final').find('.contentTab')});
                 ng.LoadAjaxTabContent({url:'index.php/eaudit/lhkpn_klarifikasi/showTable/19/'+ID + '/edit', block:'#block', container:$('#penerimaanhibah').find('.contentTab')});
            })
            return false;
        })
