                            ...
                            <div class="box-body">
                                <div class="row">
                                    <div class="form-group">
										...
										<?php if(@$total_rows){ ?>
											<button type="button" class="btn btn-sm btn-default btn-print" href="<?php echo base_url().'/index.php/efill/lhkpn/tracking/printitem/'.substr(md5(@$items[0]->ID_LHKPN),5,8); ?>" title="Cetak Cover Sheet" style='width:67px;'>
	                                        	Print
	                                    	</button>
	                                    <?php }else{ echo '';} ?>	
						...
						<div class="bx-bd">
							...
							<table width="85%" class="tbl-bd" align="center">
								...
								<tr>
									...
									<td align="center">:</td>
									<td><?= @$items[0]->TEMPAT_LAHIR.', '.tgl_format(@$items[0]->TGL_LAHIR);?></td>
								</tr><tr>
									...
									<td align="center">:</td>
									<td><?= tgl_format(@$items[0]->TANGGAL_PELAPORAN);?></td>
								</tr><tr>
									<td><strong>Tanggal Penyampaian</strong></td>
									<td align="center">:</td>
									<td><?= tgl_format(@$items[0]->TANGGAL_PENERIMAAN);?></td>
								</tr><tr>
