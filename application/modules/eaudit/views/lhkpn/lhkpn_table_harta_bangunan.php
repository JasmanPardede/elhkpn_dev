...
<div class="box-body" id="wrapperHartaTidakBergerak">
    <br />
    <button type="button" class="btn btn-primary" href="index.php/efill/validasi_harta_tidak_bergerak/add/<?php echo $id_imp_xl_lhkpn; ?>/<?php echo rand(23452, 43456); ?>" title="Edit" onclick="onButton.go(this, null, true);"><i class="fa fa-plus"></i> Tambah</button>
    <br />
    <br />
