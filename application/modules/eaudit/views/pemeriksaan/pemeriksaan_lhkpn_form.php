...
if ($display == 'pemeriksaan') {
    ...
    <!--                 <pre>
					...
					<label>
					Tanggal Klarifikasi : <?php echo tgl_format($LHKPN->TGL_KLARIFIKASI); ?>

					</label>
                    <div>
                        <!-- Nav tabs -->
                        <ul class="nav nav-tabs" role="tablist" id="tabUtama">
                            <!-- <li role="presentation" class="active"><a href="#home" aria-controls="home" role="tab" data-toggle="tab">Home</a></li> -->
							<!--<li role="presentation" class="active"><a href="#klarifikasi" aria-controls="klarifikasi" role="tab" data-toggle="tab" class="navTab klarifikasi navTabKlarifikasi" title="Data Pribadi"><?php echo ICON_klarifikasi; ?> <span>Tanggal Klarifikasi</span></a></li>-->
                        ...
                        <div class="tab-content" style="padding: 5px; border:1px solid #cfcfcf; margin-top: -1px;">
                            ...
                            <div role="tabpanel" class="tab-pane active" id="datapribadi">
                                <div class="contentTab">
                                    <?php require_once('pemeriksaan_tabel_pribadi.php'); ?>
                                </div>
                            ...
                            <div role="tabpanel" class="tab-pane" id="jabatan">
                                <div class="contentTab">
                                    <?php require_once('pemeriksaan_tabel_jabatan.php'); ?>
                                </div>
                                <div class="pull-right">
                            ...
                            <div role="tabpanel" class="tab-pane" id="keluarga">
                                <div class="contentTab">
                                    <?php require_once('pemeriksaan_tabel_keluarga.php'); ?>
                                </div>
                                <div class="pull-right">
                            ...
                            <div role="tabpanel" class="tab-pane" id="harta">
                                <ul class="nav nav-tabs" role="tablist" id="subtab-list">
                                ...
                                <div class="tab-content" style="padding: 5px; border:1px solid #cfcfcf;margin-top: -1px;">
                                    ...
                                    <div role="tabpanel" class="tab-pane active" id="hartatidakbergerak">
                                        <div class="contentTab">
                                            <?php require_once('pemeriksaan_tabel_hartatidakbergerak.php'); ?>
                                        </div>
                                    ...
                                    <div role="tabpanel" class="tab-pane" id="hartabergerak">
                                        <div class="contentTab">
                                            <?php require_once('pemeriksaan_tabel_hartabergerak.php'); ?>
                                        </div>
                                    ...
                                    <div role="tabpanel" class="tab-pane" id="hartabergerakperabot">
                                        <div class="contentTab">
                                            <?php require_once('pemeriksaan_tabel_hartabergerakperabot.php'); ?>
                                        </div>
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    ...
                                    <div role="tabpanel" class="tab-pane" id="suratberharga">
                                        <div class="contentTab">
                                            <?php require_once('pemeriksaan_tabel_suratberharga.php'); ?>
                                        </div>
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    ...
                                    <div role="tabpanel" class="tab-pane" id="kas">
                                        <div class="contentTab">
                                            <?php require_once('pemeriksaan_tabel_kas.php'); ?>
                                        </div>
                                        <div class="pull-right">
                                            <button type="button" class="btn btn-sm btn-warning btn-save-data btnPreviousHarta"><i class="fa fa-backward"></i> Sebelumnya</button>
                                            <button type="button" class="btn btn-sm btn-warning btn-save-data btnNextHarta">Simpan & Lanjut <i class="fa fa-forward"></i></button>
                                    ...
                                    <div role="tabpanel" class="tab-pane" id="hartalainnya">
                                        <div class="contentTab">
                                            <?php require_once('pemeriksaan_tabel_hartalainnya.php'); ?>
                                        </div>
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    ...
                                    <div role="tabpanel" class="tab-pane" id="hutang">
                                        <div class="contentTab">
                                            <?php require_once('pemeriksaan_tabel_hutang.php'); ?>
                                        </div>
                                        <div class="pull-right">
                                            <button type="button" class="btn btn-sm btn-warning btn-save-data btnPreviousHarta"><i class="fa fa-backward"></i> Sebelumnya</button>
                            ...
                            <div role="tabpanel" class="tab-pane" id="lampiran">
                                ...
                                <div class="tab-content" style="padding: 5px; border:1px solid #cfcfcf;margin-top: -1px;">
                                    ...
                                    <div role="tabpanel" class="tab-pane active" id="pelepasanharta">
                                        <div class="contentTab">
                                            <?php require_once('pemeriksaan_table_lampiran_1.php'); ?>
                                        </div>
                                        <div class="pull-right">
                                    ...
                                    <div role="tabpanel" class="tab-pane" id="penerimaanhibah">
                                        <div class="contentTab">
                                            <?php require_once('pemeriksaan_table_lampiran_1_1.php'); ?>
                                        </div>
                                        <div class="pull-right">
                                    ...
                                    <?php require_once('pemeriksaan_table_surat_kuasa.php');?>
                                        </div>
                                        <div class="pull-right">
                                            <button type="button" class="btn btn-sm btn-warning btn-save-data btnPreviousLampiran"><i class="fa fa-backward"></i>Sebelumnya</button>
...
<!--                                    <div role="tabpanel" class="tab-pane" id="dokumenpendukung">
                            ...
                            <div role="tabpanel" class="tab-pane" id="penerimaankas">
                                <div class="contentTab">
                                    <?php require_once('pemeriksaan_tabel_penerimaankas.php'); ?>
                                </div>
                                <br>
                                <div class="clearfix"></div>
                            </div>
                            ...
                            <div role="tabpanel" class="tab-pane" id="pengeluarankas">
                                <div class="contentTab">
                                    <?php require_once('pemeriksaan_tabel_pengeluarankas.php'); ?>
                                </div>
                                <br>
                                <div class="clearfix"></div>
                            </div>
                            ...
                            <div role="tabpanel" class="tab-pane" id="penerimaanfasilitas">
                                <div class="contentTab">
                                    <?php require_once('pemeriksaan_table_lampiran_2.php'); ?>
                                </div>
                                <div class="pull-right">
                            ...
                            <div role="tabpanel" class="tab-pane" id="final">
                                <?php require_once('pemeriksaan_tabel_historyverifikasi.php'); ?>
                                <form method="post" action="index.php/eaudit/pemeriksaan/save/lhkpn/" id="ajaxFormFinal">
...
<!--                                                                                                <tr id="dokumenpendukungFinal">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 modal-warning">
                                        <div class="modal-body col-md-12">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                $('#mail_true').hide(); $('#mail_tidak_lengkap').hide(); $('#mail_ditolak').show(); $('#pesan_reject').hide(); <?php } else { ?> $('#mail_false').show();
                                                $('#mail_true').hide(); $('#mail_tidak_lengkap').hide(); $('#mail_ditolak').hide(); $('#pesan_reject').hide();reloadCatatan(<?php echo $ID_LHKPN; ?>); <?php } ?>" required><?php if(($LHKPN->STATUS == '1' || $LHKPN->STATUS == '2') && ($LHKPN->ALASAN == '1' || $LHKPN->ALASAN == '2')) { ?> Ditolak <?php } else { ?> Perlu Perbaikan <?php } ?></label></div>
                                            </div>
                                        </div>
                                    ...
                                    <div <?php // echo ($stat === true ? 'style="display: none;"' : '')        ?> style="display: none;" class="col-xs-12 col-sm-12 col-md-12 col-lg-12 div-msg" id="mail_false">
                                        ...
                                        <?php
                                        $days = ($LHKPN->entry_via == '1') ? "14 days" : "14 days";
                                        ...
                                        $content_ditolak = "Bersama ini kami sampaikan bahwa LHKPN Tanggal $LHKPN->tgl_lapor atas nama Saudara dinyatakan DITOLAK dikarenakan KPK belum menerima kekurangan dokumen kelengkapan atas nama Saudara sesuai dalam jangka waktu yang telah ditentukan.";
                                        ?>
...
<!--                                            <textarea id="MSG_VERIFIKASI" name="MSG_VERIFIKASI" rows="10" style="width: 100%;" class="ckeditor">
                                        ...
                                        <textarea id="MSG_VERIFIKASI" name="MSG_VERIFIKASI" rows="10" style="width: 100%;" class="ckeditor" readonly="">
                                                                       <table style="width:100%" >
                                                                            <tr>
                                                                            ...
                                                                            <tr>
                                                                              <td colspan="4"><div align="justify">Bakal Calon Kepala Daerah wajib menyampaikan kekurangan dokumen pendukung sebagaimana tercantum dalam lampiran email ini kepada KPK dalam waktu tidak melebihi tanggal tersebut di atas. Dalam hal Bakal Calon Kepala Daerah tidak memenuhi kewajiban tersebut, maka KPK hanya akan memberikan Tanda Terima dengan catatan hasil verifikasi Tidak Lengkap atau menyatakan LHKPN DITOLAK sesuai dengan pedoman yang berlaku di KPK. </div></td>
                                                                            </tr>
                                                                            <tr>
                                        ...
                                        <div >   
                                            ...
                                            <button type="button" class="btn btn-warning" onClick="reloadCatatan(<?php echo $ID_LHKPN ?>)">Reload Catatan</button>
                                            <input type="hidden" id="ID_LHKPN_TRUE" value="<?php echo $ID_LHKPN; ?>">
                                            <textarea id="MSG_VERIFIKASI_INSTANSI" name="MSG_VERIFIKASI_INSTANSI" rows="10" style="width: 100%;" class="ckeditor" readonly="">
...
//                                                            $Jenis = ['DATAPRIBADI' => 'Data Pribadi', 'JABATAN' => 'Jabatan', 'KELUARGA' => 'Keluarga', 'HARTATIDAKBERGERAK' => 'Tanah / Bangunan', 'HARTABERGERAK' => 'Mesin / Alat Transportasi', 'HARTABERGERAK2' => 'Harta Bergerak Lainnya', 'SURATBERHARGA' => 'Surat Berharga', 'KAS' => 'Kas', 'HARTALAINNYA' => 'Harta Lainnya', 'HUTANG' => 'Hutang', 'PENERIMAANKAS' => 'Penerimaan Kas', 'PENGELUARANKAS' => 'Pengeluaran Kas', 'PELEPASANHARTA' => 'Pelepasan Harta', 'PENERIMAANHIBAH' => 'Penerimaan Hibah', 'PENERIMAANFASILITAS' => 'Penerimaan Fasilitas', 'DOKUMENPENDUKUNG' => 'Dokumen Pendukung', 'SURATKUASAMENGUMUMKAN' => 'Surat Kuasa'];
                                    ...
                                    <div style="display:none;" class="col-xs-12 col-sm-12 col-md-12 col-lg-12 div-msg" id="mail_true">
                                        ...
                                        <button type="button" class="btn btn-warning" onClick="reloadCatatan(<?php echo $ID_LHKPN ?>)">Reload Catatan</button>
                                        <input type="hidden" id="ID_LHKPN_TRUE" value="<?php echo $ID_LHKPN; ?>">
                                        <textarea id="MSG_VERIFIKASI_TRUE" name="MSG_VERIFIKASI_TRUE" rows="10" style="width: 100%;" class="ckeditor" readonly="">
                                                                    <table>
                                                                         <tr>
                                                                                 <td>
                                ...
                                © 2016 Direktorat PP LHKPN KPK | www.kpk.go.id. | elhkpn.kpk.go.id | Layanan LHKPN 198
                                    ...
                                    <div style="display:none;" class="col-xs-12 col-sm-12 col-md-12 col-lg-12 div-msg" id="mail_ditolak">
                                        ...
                                        <textarea id="MSG_VERIFIKASI_DITOLAK" name="MSG_VERIFIKASI_DITOLAK" rows="10" style="width: 100%;" class="ckeditor" readonly="">
                                                                    <table>
                                                                         <tr>
                                                                                 <td>
                                                                         Yth. Sdr. <?= $LHKPN->NAMA_LENGKAP; ?> <br/>
                                                            ...
                                                            ?>
                                                                        ...
                                                                        <table>
                                    <p>Bersama ini kami sampaikan bahwa LHKPN Tanggal <?php echo tgl_format($LHKPN->tgl_lapor);?> atas nama Saudara dinyatakan DITOLAK dikarenakan KPK belum menerima kekurangan dokumen kelengkapan atas nama Saudara sesuai dalam jangka waktu yang telah ditentukan.
   ...
   //var hash = window.location.hash; console.log(hash);
	//$('#tabUtama a[href="' + hash + '"]').tab('show');
											...
											//	// on load of the page: switch to the currently selected tab
											//		var hash = window.location.hash; console.log(hash);
											//		$('#subtab-list a[href="' + hash + '"]').tab('show');
...
//                                                    }
                                            ...
                                            $(document).ready(function() {
                                                ...
                                                $('#btnPreviewMSG_VERIFIKASI').click(function() {
                                                    var url = 'index.php/ever/pemeriksaan/previewmsg';
...
//                                                    OpenModalBox('Preview', html, f_close, 'large');
                                                ...
                                                $('#btnPreviewMSG_VERIFIKASI_INSTANSI').click(function() {
                                                    url = 'index.php/ever/pemeriksaan/previewmsg';
...
//                                                    OpenModalBox('Preview', html, f_close, 'large');
                                                ...
                                                $('.btnCancel').click(function() {
                                                    url = 'index.php/eaudit/verification/index/lhkpn';
												...
												$('.btnNextKlarifikasi').click(function(e) {
                                                    e.preventDefault();
                                                    var val = $('input[name="klarifikasi"]:checked').val();
                                                    modifCKEDITOR(val, 'ck_klarifikasi');
                                                    $('.nav-tabs > .active').next('li').find('a').trigger('click');
                                                });
...
//                                                            f_checkboxVer(this);
                                                        ...
                                                        $.ajax({
                                                            ...
                                                            success: function(res) {
                                                                $('#loader_area').hide();
                                                                if (id == 'btnDraft') {
                                                                    var link = 'index.php/eaudit/pemeriksaan/index/lhkpn/';
                                                                    ng.LoadAjaxContent(link);
                                                                }
                                                            }
                                                        });
...
//                                                                    (vfinal == '5') ? swal("LHKPN Terverifikasi Tidak Lengkap !", "Surat Tanda Terima (softcopy) akan dikirim melalui email ke <?= $tampil2; ?>", "success") : '';
                                                                    ...
                                                                    $.get(link, function(data) {
                                                                        ...
                                                                        $.ajax({
                                                                            url: 'index.php/eaudit/pemeriksaan/pesan_pdf/',
                                                                            method: 'POST',
