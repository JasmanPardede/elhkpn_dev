...
<section class="content-header">
  <div class="panel panel-default">
    <div class="panel-heading"><strong>REGULASI</strong></div>
    </div>
    <?php echo $breadcrumb; ?>
</section>
      ...
      <div class="panel panel-default">
                    ...
                    <div class="col-md-5">
                        <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control input-sm" placeholder="Nomor Regulasi" name="CARI[TEXT]" value="<?php echo htmlspecialchars(stripcslashes(@$CARI['TEXT']), ENT_QUOTES); ?>" id="TEXT"/>
                                </div>
                            </div>
                            <div class="form-group">
        ...
        <div class="col-md-12">
            <div class="box box-primary">
              ...
              <div class="col-md-2">
              <?php
              echo '<button class="btn btn-sm btn-primary" id="btn-add" href="index.php/ereg/reg_sos/add_form"><i class="fa fa-plus"></i> Tambah Data</button>';
              ?>
              </div>
              </div>
				<div class="box-body">
...
<script language="javascript">
    ...
    var btnEditOnClick = function (self) {
        ...
        $.post(url, function (html) {
            $('#loader_area').hide();
            OpenModalBox('Edit Regulasi', html, '', 'standart');
        });
        return false;
    ...
    var tblDaftarInstansi = {
        ...
        conf: {
            ...
            "responsive": true,
            "bAutoWidth": false,
            "sAjaxSource": "<?php echo base_url('ereg/reg_sos/load_data_regulasi'); ?>",
            ...
            "aoColumns": [
                ...
                {"mDataProp": "NOMOR_REGULASI", bSearchable: true},
                {"mDataProp": "PENGELOLA_LHKPN", bSearchable: true},
                {"mDataProp": "SANKSI", bSearchable: true},
                {"mDataProp": "WAJIB_LAPOR", bSearchable: true},
                {"mDataProp": function (source, type, val){
                    if(source.STATUS==1){
                        return '<b><font color="green">Regulasi LHKPN Sudah Diterima KPK</font></b>';
                    }else{
                        return '<b><font color="red">Regulasi LHKPN Belum Diterima KPK</font></b>';
                    }
                ...
                {"mDataProp": function(source, type, val){
                    var btnImg = source.btn_file_regulasi;
                    return btnImg.toString();
                ...
                {"mDataProp": function (source, type, val) {
                        ...
                        var btnEdit = '<button type="button" class="btn btn-warning btn-sm btn-edit" href="index.php/ereg/reg_sos/edit_form/' + source.ID_REGULASI + '" title="Edit" onclick="btnEditOnClick(this);"><i class="fa fa-pencil"></i></button>';
                     
                        var btnDelete = '<button type="button" class="btn btn-danger btn-sm btn-delete" href="index.php/ereg/reg_sos/delete_form/' + source.ID_REGULASI + '" title="Delete" onclick="btnDeleteOnClick(this);"><i class="fa fa-trash" style="color:white;"></i></button>';
                        <?php if ($this->session->userdata('ID_ROLE') == 2 || $this->session->userdata('ID_ROLE') == 31){ ?>
                        if(source.STATUS==0){
                            btnApprove = '<button type="button" class="btn btn-success btn-sm" href="index.php/ereg/reg_sos/approve_form/' + source.ID_REGULASI + '" title="Regulasi LHKPN Sudah Diterima" onclick="btnDeleteOnClick(this);"><i class="fa fa-check" style="color:white;"></i></button>';
                        }else{
                            btnApprove = '<button type="button" class="btn btn-danger btn-sm" href="index.php/ereg/reg_sos/approve_form/' + source.ID_REGULASI + '" title="Regulasi LHKPN Sudah Diterima" onclick="btnDeleteOnClick(this);"><i class="fa fa-times" style="color:white;"></i></button>';
                        }
                        <?php }else{ ?>
                        var btnApprove = "";
                        <?php } ?>
    ...
    $(document).ready(function () {
        data_is_active = [{id: 9, text: '--Semua Data--'},{id: 1, text: 'Regulasi LHKPN Sudah Diterima KPK'}, {id: 0, text: 'Regulasi LHKPN Belum Diterima KPK'}];
        ...
        $("#btn-add").click(function () {
            ...
            $.post(url, function (html) {
                $('#loader_area').hide();
                OpenModalBox('Tambah Regulasi', html, '');
            });
            return false;
        });
	});
