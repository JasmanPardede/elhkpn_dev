    ...
    <form method="post" id="ajaxFormAdd" action="index.php/ereg/reg_sos/save_regulasi" enctype="multipart/form-data">
        <div class="box-body">
            ...
            <div class="form-group form-file">
                <div class="col-sm-1"></div>
                <div class="col-sm-10">
                    <label>Upload file Regulasi (pdf)</label> 
                    <?= FormHelpPopOver('file_regulasi'); ?>
                    <input type="file" id="file_regulasi" name="fileRegulasi[]" class="form-control" multiple data-allowed-file-extensions='["pdf"]'  data-show-preview="true" onchange="return validasiFile()" />
        ...
        <div class="pull-right">
            ...
            <button type="submit" id="button-saved" class="btn btn-primary btn-sm"><i class="fa fa-share"></i>Simpan</button>
...
<div id="wrapperFormEdit" class='form-horizontal'>
    <form method="post" id="ajaxFormEdit" action="index.php/ereg/reg_sos/save_regulasi">
        ...
        <div class="pull-right">
            <input type="hidden" id="ID_REGULASI" name="ID_REGULASI" value="<?php echo $item->ID_REGULASI;?>">
            <input type="hidden" name="act" value="doupdate">
            <button type="submit" class="btn btn-primary btn-sm" id="button-saved"><i class="fa fa-share"></i>Simpan</button>
            <button type="reset" class="btn btn-danger btn-sm " onclick="CloseModalBox2();"><i class="fa fa-remove"></i>Batal</button>
...
<?php if($form=='add' || $form=='edit'){ ?>
<script>
    function validasiFile(){
        var inputFile = document.getElementById('file_regulasi');
        ...
        var fileUpload = $('#file_regulasi')[0].files.length;

        if(size_total > 10000000){ 
            alert('Silakan upload file size maksimal 10 Mb');
            inputFile.value = '';
        }
