...
<section class="content-header">
  <div class="panel panel-default">
    <div class="panel-heading"><strong>DAFTAR NON WAJIB LAPOR</strong></div>
    </div>
    <?php echo $breadcrumb; ?>
</section>
...
<?php if ($this->session->userdata('ID_ROLE') == 1 || $this->session->userdata('ID_ROLE') == 2 || $this->session->userdata('ID_ROLE') == 3 || $this->session->userdata('ID_ROLE') == 7 || $this->session->userdata('ID_ROLE') == 10 || $this->session->userdata('ID_ROLE') == 13 || $this->session->userdata('ID_ROLE') == 14 || $this->session->userdata('ID_ROLE') == 18 || $this->session->userdata('ID_ROLE') == 31): ?>
                                <div class="form-group">
...
<?php endif; ?>
                            ...
                            <div class="form-group" style="margin-bottom:12px">
                                <label class="col-sm-4 control-label">Status WL:</label>
                                <div  class="col-sm-6">
                                    <input type='text' class="input-sm select2 form-control" name='CARI[IS_DELETED]' style="border:none;padding:6px 0px;" id='CARI_IS_DELETED' value='<?php echo @$CARI['IS_DELETED']; ?>' placeholder="All">
                                </div>
                            </div>
