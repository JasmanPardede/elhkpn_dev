...
<div id="wrapperFormAdd">
    <form class="form-horizontal forminput" method="post" id="ajaxFormAdd" action="index.php/ereg/all_pn/do_act_pn/<?php echo isset($daftar_pn->ID_PN) ? $daftar_pn->ID_PN : ""; ?>/<?php echo isset($daftar_pn->ID) ? $daftar_pn->ID : ""; ?>" enctype="multipart/form-data">
        ...
        <div id="wrapperFormAddPN">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    ...
                    <input  readonly="readonly" required class="form-control" value="<?php echo isset($daftar_pn->NAMA) ? $daftar_pn->NAMA : ""; ?>" onkeyup="this.value = this.value.toUpperCase()" type='text' size='40' name='NAMA' id='NAMA' <?= FormHelpPlaceholderToolTip('nama') ?>>
                </div>
                <div class="col-sm-1"></div>
            </div>
        </div>
        ...
        <div class="form-group">
            <div class="col-sm-1"></div>
            <div class="col-sm-5">
                <input  readonly="readonly" required class="form-control" onkeyup="this.value = this.value.toUpperCase()" value="<?php echo isset($daftar_pn->TEMPAT_LAHIR) ? $daftar_pn->TEMPAT_LAHIR : ""; ?>" data-toggle="tooltip" title="Tempat Lahir" type='text'name='TEMPAT_LAHIR' id='TEMPAT_LAHIR' placeholder="Tempat">
            </div>
            <div class="col-sm-5">
                <input readonly="readonly" disabled=""  required class="form-control" value="<?php echo isset($daftar_pn->TGL_LAHIR) ? $this->lib_date->set_date_format($this->lib_date->set_tanggal($daftar_pn->TGL_LAHIR)) : ""; //isset($daftar_pn->TGL_LAHIR) ? $daftar_pn->TGL_LAHIR : ""; ?>" data-toggle="tooltip" title="Taggal Lahir" type='text'name='TGL_LAHIR' id='TGL_LAHIR' placeholder='DD/MM/YYYY'>
            </div>
            <div class="col-sm-1"></div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                ...
                <select disabled="" readonly="readonly" required class="form-control" name="JNS_KEL" id="JNS_KEL">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                ...
                <input  readonly="readonly" name='NIP' id='NIP'  type="text" value="<?php echo isset($daftar_pn->NIP_NRP) ? $daftar_pn->NIP_NRP : ""; ?>" class="form-control" <?= FormHelpPlaceholderToolTip('nip', true) ?>>
            </div>
            <div class="col-sm-1">
            </div>
        </div>
			...
			<div id="divFieldInputNikBaru" class="form-group">
					...
					<div class="col-sm-10">
						...
						<div class="input-group">
							<input name='NIK_BARU' id='NIK_BARU' onkeyup="HitungText_();"  type="text" class="form-control" <?php echo FormHelpPlaceholderToolTip('nik_baru', false); ?>maxlength="16">
...
<?php } ?>
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				...
				{
					?>
					<input onblur ="AutoCalculateMandateOnChange(this);" type='checkbox' name='is_aplikasi' checked onclick="AutoCalculateMandateOnChange(this);">
					<?php
				}	
				else{
					?>
					<input onblur ="AutoCalculateMandateOnChange(this);" type='checkbox' name='is_aplikasi' onclick="AutoCalculateMandateOnChange(this);">
					<?php
				}				
				?>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                ...
                <input type='email' class="form-control" name='EMAIL' size='40' id='EMAIL' onblur="cek_email(this.value, <?php echo $daftar_pn->ID_USER;?>);" value="<?php echo isset($daftar_pn->EMAIL) ? $daftar_pn->EMAIL : ""; ?>" <?= FormHelpPlaceholderToolTip('email') ?> placeholder="Email"  required >
 ...
 -->        </div>
		...
		<div class="form-group">
            ...
            <div class="col-sm-10">
                ...
                <select disabled="" required class="form-control" name="TAHUN_WL" id="TAHUN_WL">
