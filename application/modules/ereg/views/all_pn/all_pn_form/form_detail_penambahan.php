<div id="wrapperFormDetail">
    ...
    <div class="pull-right">
        <button type="button" class="btn btn-success btn-sm " onclick="app_vi_add(<?php echo $item->ID_PN; ?>,<?php echo $idjb; ?>,<?php echo $item->IS_APLIKASI; ?>,<?php echo $item->ID_USER; ?>,<?php echo $calon; ?>); CloseModalBox2();"><i class="fa fa-check"></i> Approve</button>
        <button type="button" class="btn btn-danger btn-delete"  href="index.php/ereg/all_pn/delete_daftar_pn_individual/<?php echo $item->ID_PN; ?>/<?php echo $calon; ?>"><i class="fa fa-undo"></i> Decline</button>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        function app_vi_add(idpn, idj, is_aplikasi, iduser) {
