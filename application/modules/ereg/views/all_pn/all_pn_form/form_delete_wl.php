<div id="wrapperFormDelete">
    Benarkah Akan Menonaktifkan Wajib Lapor dibawah ini ?
    <!-- <form method="post" id="ajaxFormDelete" action="index.php/ereg/all_pn/savepn"> -->
    <form method="post" id="ajaxFormDelete" action="index.php/ereg/all_pn/do_nonact_pn_wl/<?php echo $item->ID_PN; ?>/<?php echo $idjpn; ?>">
...
<!-- 		<tr><td>Pendidikan Terakhir</td><td>:</td><td>
        ...
        <!-- <tr><td>Alamat Tinggal</td><td>:</td><td><?php echo $item->ALAMAT_TINGGAL ?></td></tr> -->
            ...
            <tr><td>Alasan<span class="red-label">*</span></td><td>:</td>
                <td>
                    <select required name="alasan_non_wl" id="alasan_non_wl">
                        <option value="">--Pilih Alasan--</option>
                        <option value="Meninggal">Meninggal</option>
                        <option value="Pensiun">Pensiun</option>
                        <option value="Mutasi">Mutasi</option>
                        <option value="Pindah Instansi">Pindah Instansi</option>
                        <option value="Lainnya">Lainnya</option>
                    </select>
                </td>
                <!-- /*ab mengganti text area*/ <textarea class="form-control" rows="3" required name="alasan_non_wl" id="alasan_non_wl"  /> -->
            </tr>
            <!-- /*ab*/ disini akan dilakukan perubahan label -->
        ...
        <div class="pull-right">
            ...
            <input type="hidden" name="tahun_wl" value="<?php echo $tahun_wl[0]->tahun_wl;?>">
            <button type="submit" class="btn btn-sm btn-primary">Non WL</button>
...
<script type="text/javascript">
    $(document).ready(function () {
        //ng.formProcess($("#ajaxFormDelete"), 'delete', 'location.href.split('#')[1]', null, null, null, 'Data tidak bisa di Non WL kan!');
        var dtTable = $('#dt_completeNEW').DataTable();
        var tahunwl = $("input[name='tahun_wl']").val();
        ng.formProcess($("#ajaxFormDelete"), 'delete', '', null, null, null, 'Data tidak dapat dinonwajiblaporkan, karena WL sudah lapor di tahun ' + tahunwl + '!');
