<div id="wrapperFormDetail">
    ...
    <div class="pull-right">
        <button type="button" class="btn btn-success btn-sm "  onclick="app_vi_nonact(<?php echo $item->ID_PN; ?>,<?php echo $idjb; ?>); CloseModalBox2();"><i class="fa fa-check"></i> Approve</button>

        <button type="button" class="btn btn-danger btn-delete"  href="index.php/ereg/All_pn/Cancel_VerNon_wlon/<?php echo $item->ID_PN; ?>/<?php echo $idjb; ?>"><i class="fa fa-undo"></i> Decline</button>
