<div id="wrapperFormDelete">
    Benarkah Akan Menghapus Non Wajib Lapor dibawah ini ?
    <!-- <form method="post" id="ajaxFormDelete" action="index.php/ereg/all_pn/savepn"> -->
    <form method="post" id="ajaxFormDelete" action="index.php/ereg/all_pn/do_nonact_pn_wl_non/<?php echo $item->ID_PN . '/' . $idjpn; ?>">
...
<!-- 		<tr><td>Pendidikan Terakhir</td><td>:</td><td>
        ...
        <div class="pull-right">
            ...
            <button type="submit" class="btn btn-sm btn-primary">Hapus Non WL</button>
