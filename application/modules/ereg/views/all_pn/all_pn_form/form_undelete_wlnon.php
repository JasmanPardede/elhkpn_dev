<div id="wrapperFormDelete">
    Benarkah Anda akan mengaktifkan kembali PN/WL dibawah ini ke dalam daftar Non Wajib Lapor ?
    <!-- <form method="post" id="ajaxFormDelete" action="index.php/ereg/all_pn/savepn"> -->
    <form method="post" id="ajaxFormDelete" action="index.php/ereg/all_pn/do_act_non_pn_wl_non/<?php echo $item->ID_PN . '/' . $idjpn; ?>">
...
<!-- 		<tr><td>Pendidikan Terakhir</td><td>:</td><td>
        ...
        <div class="pull-right">
            ...
            <button type="submit" class="btn btn-sm btn-primary">Aktifkan PN/WL</button>
