<div id="wrapperFormDetail">
    ...
    <div class="pull-right">
        ...
        <button type="button" class="btn btn-danger btn-delete"  onclick="Cancel_VerNon_wloff(<?php echo $item->ID_PN; ?>,<?php echo $idjb; ?>); CloseModalBox2();"><i class="fa fa-undo"></i> Decline</button>
