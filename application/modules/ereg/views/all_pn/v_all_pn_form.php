...
<div id="wrapperFormAdd">
    <form class="form-horizontal" name="forminput" method="post" id="ajaxFormAdd" actrel="index.php/ereg/all_pn/savepnwl/<?php echo $iscln; ?>" action="#" enctype="multipart/form-data">
        <div id="wrapperFormAddPN"> 
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        ...
                        <input class="form-control" onkeyup="this.value = this.value.toUpperCase()" type='text' size='40' name='GELARDEPAN' id='GELARDEPAN' <?php echo FormHelpPlaceholderToolTip('gelar_dpn_dp') ?>>
                    </div>
                    <div class="col-sm-1"></div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        ...
                        <input required class="form-control field-required" onkeyup="this.value = this.value.toUpperCase()" type='text' size='40' name='NAMA' id='NAMA' <?php echo FormHelpPlaceholderToolTip('nama_pnwl') ?>>
                    </div>
                    <div class="col-sm-1"></div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        ...
                        <input class="form-control" onkeyup="this.value = this.value.toUpperCase()" type='text' size='40' name='GELARBELAKANG' id='GELARBELAKANG' <?php echo FormHelpPlaceholderToolTip('gelar_blk_dp') ?>>
                    </div>
                    <div class="col-sm-1"></div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <div class="col-sm-1"></div>
                    <div class="col-sm-5">
                        <input required class="form-control field-required" onkeyup="this.value = this.value.toUpperCase()" type='text'name='TEMPAT_LAHIR' id='TEMPAT_LAHIR' <?php echo FormHelpPlaceholderToolTip('tempat_tanggal_lahir_pnwl') ?> >
                    </div>
                    <div class="col-sm-5">
                        <input required class="form-control TGL_LAHIR field-required" type='text'name='TGL_LAHIR' id='TGL_LAHIR' placeholder='DD/MM/YYYY'>
                    </div>
                    <div class="col-sm-1"></div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        ...
                        <select required class="form-control field-required" name="JNS_KEL" id="JNS_KEL">
            ...
            <div class="col-md-6">
                <div id="wrapperFormJabatan">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            <input type='text' class="form-control form-select2 field-required" name='LEMBAGA' style="border:none;" <?php echo $isInstansi ? "value='$isInstansi' readonly='readonly'" : '' ?> id='LEMBAGA'  placeholder="lembaga" required onchange="clearvalue(this)">
                        </div>
                        <div class="col-sm-1">
                        </div>
                    </div>
                    ...
                    <?php if ($iscln == 1) { // Untuk Calon PNWL ?>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                ...
                                <input type='text' class="form-control form-select2 field-required" name='UNIT_KERJA' style="border:none;" <?php echo $is_uk ? "value='$is_uk' readonly='readonly'" : '' ?> id='UNIT_KERJA'  placeholder="Unit Kerja" required>
                            </div>
                            <div class="col-sm-1">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                ...
                                <input type="text" class="form-control form-select2 field-required" name="JABATAN" style="border:none;" id='JABATAN' value="" placeholder="Jabatan" required>
                            </div>
                            <div class="col-sm-1">
                            </div>
                        </div>
                    <?php } else { ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <label>Unit Kerja <span class="red-label">*</span></label> 
                                <?php echo FormHelpPopOver('unit_kerja_pnwl'); ?>
                                <input type='text' class="form-control form-select2 field-required" name='UNIT_KERJA' style="border:none;" id='UNIT_KERJA' <?php echo $is_uk ? "value='$is_uk' readonly='readonly'" : '' ?>   placeholder="Unit Kerja" required>
                            </div>
                            <div class="col-sm-1">
                            </div>
                        </div>
                ...
                <!-- <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <label>Pelaporan Online</label> 
                        <input type='checkbox' id="is_aplikasi" value="1" name='is_aplikasi' onclick='AutoCalculateMandateOnChange(this);'>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        ...
                        <select required class="form-control field-required" name="TAHUN_WL" id="TAHUN_WL">
                            <option value="<?= getdate()['year']; ?>"><?= getdate()['year']; ?></option>
                            <!-- <option value="<?= getdate()['year']-1; ?>"><?= getdate()['year']-1; ?></option> -->
                        </select>
                        <div class="col-sm-1"></div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        ...
                        <input required  type='email' class="form-control field-required" name='EMAIL' size='40' id='EMAIL' onblur="cek_emails(this.value);" value='' <?php echo FormHelpPlaceholderToolTip('email_pnwl'); ?> placeholder="">
                        <?php
                        /**
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        ...
                        <input required class="form-control field-required" type='text' size='40'  onblur="cek_nohp(this);" name='NO_HP' id='NO_HP' <?php echo FormHelpPlaceholderToolTip('handphone_pnwl') ?> >
                    </div>
                    <div class="col-sm-1">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <div class="pull-right">
                            ...
                            <button type="button" class="btn btn-sm btn-primary" id="btnSubmit" onclick="formcheck(); return false;"><i class="fa fa-share"></i>Simpan <?php echo (@$iscln == '1' ? 'Calon ' : '') ?>PN/WL</button>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#NIK').on('paste', numberOnly.pasteNIK);
