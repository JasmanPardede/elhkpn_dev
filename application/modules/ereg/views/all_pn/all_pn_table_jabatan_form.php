...
if ($form == 'kllJabatan') {
    ...
    <div id="wrapperKllJabatan">
        <form class="form-horizontal ahaha" id="saveklljabatan" action="javascript:;" enctype="multipart/form-data">
            <input type="hidden" id="ID_PN" name="PNID" value="<?php echo $id_pn; ?>" />
            <div class="box-body form-horizontal">
                <div class="col-sm-12">
                    <div class="form-group">
                        <label class="col-sm-4 control-label">Nama PN <span class="red-label">*</span>:</label>
                        <div class="col-sm-8">
                            <div class="control-label" style="text-align:left !important;"><?php echo $PN->NAMA ?></div>
                        </div>
                    </div>
            ...
            <div class="pull-right"  id="verif" name="verif">
        ...
        <script type="text/javascript">
			...
			function cekTombol() {
				$("#verif").empty();
				$("#verif").html("<button id=\"btnsaveKJ\" type=\"submit\" class=\"btn btn-sm btn-primary\" onclick=\"cekTombol()\" disabled>Simpan</button>  <input type=\"button\" class=\"btn btn-sm btn-default aa\" value=\"Kembali\" onclick=\"backForm()\"> <input type=\"hidden\" name=\"act\" value=\"doinsert\">");
...
*/
    ...
    //                    var urll = 'index.php/ereg/all_pn/saveklljabatan';
                    var urll = 'index.php/ereg/all_pn/save_multy_jabatan/' +<?php echo $id_pn; ?>;
                    ...
                    $.ajax({
                        ...
                        success: function(html) {
                            ...
                            if (html == 1) {
                                ...
                                $.post('index.php/ereg/all_pn/cekNIK/' + <?php echo $PN->NIK; ?>, function(data) {
                                    //if (data != 0) {
                                        //$("#wrapperFormPNExist").html(<?php echo $PN->NIK; ?>);
                                        alertify.success('Jabatan Berhasil di tambahkan!');
										$('#div-jabatan').hide('fast');
                                ...
                                alertify.error('Jabatan Gagal di tambahkan!');
                            }
                        },
                        cache: false,
                        contentType: false,
