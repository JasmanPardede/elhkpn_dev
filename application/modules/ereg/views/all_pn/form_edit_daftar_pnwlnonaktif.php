...
<div id="wrapperFormAdd">
    <form class="form-horizontal forminput" method="post" id="ajaxFormAdd" action="index.php/ereg/all_pn/save_edit_daftar_wl_non/<?php echo isset($daftar_pn->ID_PN) ? $daftar_pn->ID_PN : ""; ?>/<?php echo isset($daftar_pn->ID) ? $daftar_pn->ID : ""; ?>" enctype="multipart/form-data">
        ...
        <div id="wrapperFormAddPN">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    ...
                    <input readonly required class="form-control" value="<?php echo isset($daftar_pn->NAMA) ? $daftar_pn->NAMA : ""; ?>" onkeyup="this.value = this.value.toUpperCase()" type='text' size='40' name='NAMA' id='NAMA' <?= FormHelpPlaceholderToolTip('nama') ?>>
                </div>
                <div class="col-sm-1"></div>
            </div>
        </div>
			...
			<div class="form-group">
				<div class="col-sm-1"></div>
				<div class="col-sm-5">
					<input readonly required class="form-control" onkeyup="this.value = this.value.toUpperCase()" value="<?php echo isset($daftar_pn->TEMPAT_LAHIR) ? $daftar_pn->TEMPAT_LAHIR : ""; ?>" data-toggle="tooltip" title="Tempat Lahir" type='text'name='TEMPAT_LAHIR' id='TEMPAT_LAHIR' placeholder="Tempat">
				</div>
				<div class="col-sm-5">
					<input  readonly required class="form-control" value="<?php echo isset($daftar_pn->TGL_LAHIR) ? $this->lib_date->set_date_format($this->lib_date->set_tanggal($daftar_pn->TGL_LAHIR)) : ""; //isset($daftar_pn->TGL_LAHIR) ? $daftar_pn->TGL_LAHIR : ""; ?>" data-toggle="tooltip" title="Taggal Lahir" type='text'name='TGL_LAHIR' id='TGL_LAHIR' placeholder='DD/MM/YYYY'>
				</div>
				<div class="col-sm-1"></div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-10">
					...
					<select  readonly required class="form-control" name="JNS_KEL" id="JNS_KEL" >
            ...
            <div class="col-sm-10">
                ...
                <input  readonly  name='NIP' id='NIP'  type="text" value="<?php echo isset($daftar_pn->NIP_NRP) ? $daftar_pn->NIP_NRP : ""; ?>" class="form-control" <?= FormHelpPlaceholderToolTip('nip', true) ?>>
            </div>
            <div class="col-sm-1">
            </div>
        </div>
        ...
        if (($a == 5 || $a == '5') || (($a == 0 || $a == '0') && ($this->session->userdata('ID_ROLE') == '2' || $this->session->userdata('ID_ROLE') == 2 || $this->session->userdata('ID_ROLE') == '31' || $this->session->userdata('ID_ROLE') == 31))) {
        ?>
            <div id="divFieldInputNikBaru" class="form-group">
				...
				<div class="col-sm-10">
					...
					<div class="input-group">
						<input name='NIK_BARU' id='NIK_BARU' onkeypress="return isNumber(event)" onkeyup="HitungText_();"  type="text" class="form-control" <?php echo FormHelpPlaceholderToolTip('nik_baru', false); ?> maxlength="16" >
...
//                        $a = $daftar_pn->EMAIL;
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                ...
                <input type='email' class="form-control" name='EMAIL' size='40' id='EMAIL' onblur="cek_email(this.value, <?php echo $daftar_pn->ID_USER;?>);" value="<?php echo isset($daftar_pn->EMAIL) ? $daftar_pn->EMAIL : ""; ?>" <?= FormHelpPlaceholderToolTip('email') ?> placeholder="Email">
		...
		<div class="form-group">
            ...
            <div class="col-sm-10">
                ...
                <select disabled="" required class="form-control" name="TAHUN_WL" id="JNS_KEL">
					<?php /* <option value="<?php echo isset($daftar_pn->TAHUN_WL) ? $daftar_pn->TAHUN_WL : date('Y'); ?>"><?php echo isset($daftar_pn->TAHUN_WL) ? $daftar_pn->TAHUN_WL : date('Y'); ?></option> */ ?>
...
<script type="text/javascript">
	...
	function HitungText_(){ 
	//var Teks = document.forminput.NIK_BARU.value.length;  
	var Teks = document.getElementById("NIK_BARU").value.length;
...
//			 $('#JABATAN').select2("data", {id: valJAB, name: "<?php //echo $daftar_pn->NAMA_JABATAN; ?>"});
        ...
        var msg = {
            ...
            custom1: 'Data ini sudah ada di wajib lapor tahun '+ dt.getFullYear() +'!',
            custom2: 'Data ini sudah ada di Verifikasi Individual, mohon direview terlebih dahulu!'
        };
            ...
            $.ajax({
                ...
                success: function(htmldata) {
                    ...
                    if (htmldata == 0) {
                        ...
                        alertify.error(msg.custom1);
                        CloseModalBox();
                        $('#loader_area').hide();
                    } else if (htmldata == 90) {
                        alertify.error(msg.custom2);
                        CloseModalBox();
                        $('#loader_area').hide();
                    } else if (htmldata == 8) {
