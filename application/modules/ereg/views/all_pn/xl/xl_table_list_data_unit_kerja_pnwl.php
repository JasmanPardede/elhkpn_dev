<Worksheet ss:Name="unit_kerja">
    <Table ss:ExpandedColumnCount="8" ss:ExpandedRowCount="<?php echo $tblRowCount; ?>" x:FullColumns="1"
        ...
        <Row ss:AutoFitHeight="0">
            <Cell ss:StyleID="s01"  ss:MergeAcross="3" ><Data ss:Type="String">TAMBAH DATA PENYELENGGARA NEGARA / WAJIB LAPOR (UNit Kerja)</Data></Cell>
        </Row>
        <Row ss:AutoFitHeight="0">
        ...
        <Row ss:AutoFitHeight="0">
            ...
            <Cell ss:StyleID="s02" ss:Index="2"><Data ss:Type="String">ID Unit Kerja</Data></Cell>
            <Cell ss:StyleID="s02" ss:Index="3"><Data ss:Type="String">Nama Instansi</Data></Cell>
            <Cell ss:StyleID="s02" ss:Index="4"><Data ss:Type="String">Nama Unit Kerja</Data></Cell>
        </Row>
