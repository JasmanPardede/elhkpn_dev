<Worksheet ss:Name="jabatan">
    <Table ss:ExpandedColumnCount="9" ss:ExpandedRowCount="<?php echo $tblRowCount; ?>" x:FullColumns="1"
        ...
        <Row ss:AutoFitHeight="0">
            ...
            <Cell ss:StyleID="s02" ss:Index="2"><Data ss:Type="String">ID Jabatan</Data></Cell>
            <Cell ss:StyleID="s02" ss:Index="3"><Data ss:Type="String">Nama Unit Kerja</Data></Cell>
            <Cell ss:StyleID="s02" ss:Index="4"><Data ss:Type="String">Nama Sub Unit Kerja</Data></Cell>
            <Cell ss:StyleID="s02" ss:Index="5"><Data ss:Type="String">Nama Jabatan</Data></Cell>
        </Row>
