        ...
        <form class="form-horizontal" method="post" id="ajaxFormAdd" data-toggle="modal" data-bakcdrop="static" action="index.php/ereg/all_user_instansi/saveuser" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    ...
                    <?= FormHelpPopOver('unit_kerja_admin_unit_kerja'); ?>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    ...
                    <?= FormHelpPopOver('sub_unit_kerja_admin_unit_kerja'); ?>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    ...
                    <?= FormHelpPopOver('jabatan_admin_unit_kerja'); ?>
            ...
            <input type="hidden" name="ID_USER" id="ID_USER" value="<?php echo $item->ID_USER; ?>">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        ...
                        <input type='text' class="form-control" name='USERNAME' id='USERNAME' onblur="cek_user(this.value,<?php echo $item->ID_USER; ?>);" value='<?php echo $item->USERNAME; ?>' required <?= FormHelpPlaceholderToolTip('username') ?> placeholder="Username" readonly>
                            <span class="help-block"><font id='username_ada' style='display:none;' color='red'>Username <span id="check_uname_add" style="font-style: italic; font-weight: bold;"></span> sudah terdaftar</font></span>
                    </div>
                    <div class="col-sm-1" style="margin-top: 5px;" id="div-username">
                        <img class="show-hide" id="fail" src="<?php echo base_url('img/fail.png') ?>" width="24" />
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <label>Unit Kerja Admin <span class="red-label">*</span></label> 
                        <input type='text' class="form-control" name='UNIT_KERJA_ADMIN' id='UNIT_KERJA_ADMIN' value='<?php echo $item->UNIT_KERJA_ADMIN;?>' required  maxlength="255" <?= FormHelpPlaceholderToolTip('unit_kerja_admin_instansi') ?>>
                    </div>
                    <div class="col-sm-1"></div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <label>Sub Unit Kerja Admin <span class="red-label">*</span></label> 
                        <input type='text' class="form-control" name='SUB_UNIT_KERJA_ADMIN' id='SUB_UNIT_KERJA_ADMIN' value='<?php echo $item->SUB_UNIT_KERJA_ADMIN;?>' required  maxlength="255" <?= FormHelpPlaceholderToolTip('sub_unit_kerja_admin_instansi') ?>>
                    </div>
                    <div class="col-sm-1"></div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <label>Jabatan Admin <span class="red-label">*</span></label> 
                        <input type='text' class="form-control" name='JABATAN_ADMIN' id='JABATAN_ADMIN' value='<?php echo $item->JABATAN_ADMIN;?>' required  maxlength="255" <?= FormHelpPlaceholderToolTip('jabatan_admin_instansi') ?>>
                    </div>
                    <div class="col-sm-1"></div>
                </div>
                <div class="pull-right">
        ...
        <form method="post" id="ajaxFormDelete" action="index.php/ereg/all_user_instansi/saveuser">
            ...
            <div class="pull-right">
                <input type="hidden" name="ID_USER" value="<?php echo $item->ID_USER; ?>">
                    ...
                    <?php
                    if ($form == 'active') { // KETIKA AKTIFKAN DATA
                        ?>
                        <div id="wrapperFormActive">
                            Apakah anda yakin akan mengaktifkan username dibawah ini?
                            <form method="post" id="ajaxFormActive" action="index.php/ereg/all_user_instansi/saveuser">
                                <table width="50%">
                                    <!-- <tr><td>Id User</td><td>:</td><td><?php echo $item->ID_USER; ?></td></tr> -->
                                    <tr><td>Username</td><td> : </td><td><?php echo $item->USERNAME; ?></td></tr>
                                    <tr><td>Nama</td><td> : </td><td><?php echo $item->NAMA; ?></td></tr>
                                ...
                                <div class="pull-right">
                                    <input type="hidden" name="ID_USER" value="<?php echo $item->ID_USER; ?>">
                                        <input type="hidden" name="act" value="doactive">
                                            ...
                                            <script type="text/javascript">
                                                $(document).ready(function() {
                                                    //ng.formProcess($("#ajaxFormActive"), 'delete', location.href.split('#')[1]);
                                                    var dtTable = $('#dt_completeNEW').DataTable();
                                                    ng.formProcess($("#ajaxFormActive"), 'delete', '');
                                                    dtTable.ajax.reload( null, false );
                                        ...
                                        if ($form == 'kirimaktivasi') {
                                            ?>
                                            <form method="post" id="ajaxFormKirimAktivasi" action="index.php/ereg/all_user_instansi/dokirimaktivasi">
                                                <input type="hidden" name="ID_USER" id="ID_USER" value="<?php echo $item->ID_USER; ?>">
                                                    <div class="col-lg-12 text-center">
