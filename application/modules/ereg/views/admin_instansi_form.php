    ...
    <form method="post" id="ajaxFormAdd" action="index.php/ereg/admin_instansi/saveuser" enctype="multipart/form-data">
        <div class="box-body">
            ...
            <div class="form-group">
                <div class="col-sm-1"></div>
                <div class="col-sm-10">
                    <label>Unit Kerja Admin <span class="red-label">*</span></label> 
                    <?= FormHelpPopOver('unit_kerja_admin_instansi'); ?>
                    <input type='text' class="form-control" name='UNIT_KERJA_ADMIN' id='UNIT_KERJA_ADMIN' value='' required  maxlength="255" <?= FormHelpPlaceholderToolTip('unit_kerja_admin_instansi') ?>>
                </div>
                <div class="col-sm-1"></div>
            </div>
            <div class="form-group">
                <div class="col-sm-1"></div>
                <div class="col-sm-10">
                    <label>Sub Unit Kerja Admin <span class="red-label">*</span></label> 
                    <?= FormHelpPopOver('sub_unit_kerja_admin_instansi'); ?>
                    <input type='text' class="form-control" name='SUB_UNIT_KERJA_ADMIN' id='SUB_UNIT_KERJA_ADMIN' value='' required  maxlength="255" <?= FormHelpPlaceholderToolTip('sub_unit_kerja_admin_instansi') ?>>
                </div>
                <div class="col-sm-1"></div>
            </div>
            <div class="form-group">
                <div class="col-sm-1"></div>
                <div class="col-sm-10">
                    <label>Jabatan Admin <span class="red-label">*</span></label> 
                    <?= FormHelpPopOver('jabatan_admin_instansi'); ?>
                    <input type='text' class="form-control" name='JABATAN_ADMIN' id='JABATAN_ADMIN' value='' required  maxlength="255" <?= FormHelpPlaceholderToolTip('jabatan_admin_instansi') ?>>
                </div>
                <div class="col-sm-1"></div>
            </div>            
        </div>
...
<div id="wrapperFormEdit" class='form-horizontal'>
    <form method="post" id="ajaxFormEdit" action="index.php/ereg/admin_instansi/saveuser">
        <div class="box-body">
            ...
            <div class="form-group">
                <label class="col-sm-4 control-label">Email <span class="red-label">*</span> :</label>
                <div class="col-sm-7">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <input type='text' class="form-control" name='NOMOR_SK' id='NOMOR_SK' value='<?php echo $item->NOMOR_SK;?>'>
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-4 control-label">Handphone <span class="red-label">*</span> :</label>
                <div class="col-sm-8">
            ...
            <div class="form-group">
                <label class="col-sm-4 control-label">Unit Kerja Admin <span class="red-label">*</span> :</label>
                <div class="col-sm-8">
                    <input type='text' class="form-control" name='UNIT_KERJA_ADMIN' maxlength="255" id='UNIT_KERJA_ADMIN' value='<?php echo $item->UNIT_KERJA_ADMIN;?>' required>
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-4 control-label">Sub Unit Kerja Admin <span class="red-label">*</span> :</label>
                <div class="col-sm-8">
                    <input type='text' class="form-control" name='SUB_UNIT_KERJA_ADMIN' maxlength="255" id='SUB_UNIT_KERJA_ADMIN' value='<?php echo $item->SUB_UNIT_KERJA_ADMIN;?>' required>
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-4 control-label">Jabatan Admin <span class="red-label">*</span> :</label>
                <div class="col-sm-8">
                    <input type='text' class="form-control" name='JABATAN_ADMIN' maxlength="255" id='JABATAN_ADMIN' value='<?php echo $item->JABATAN_ADMIN;?>' required>
                </div>
            </div>            
        </div>
        <div class="pull-right">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        // $('#INST_SATKERKD').select2();
        //ng.formProcess($("#"), 'update', location.href.split('#')[1]);  
...
if($form=='active'){
?>
<div id="wrapperFormActive" class='form-horizontal'>
    Apakah Anda yakin akan mengaktifkan username dibawah ini ?
    <form method="post" id="ajaxFormActive" action="index.php/ereg/admin_instansi/saveuser">
        <div class="box-body">
        ...
        <div class="pull-right">
            <input type="hidden" name="ID_USER" value="<?php echo $item->ID_USER;?>">
            <input type="hidden" name="act" value="doactive">
           <button type="submit" class="btn btn-primary btn-sm"><i class="fa fa-cloud-upload"></i>Aktifkan</button>
            <button type="reset" class="btn btn-danger btn-sm " onclick="CloseModalBox2();"><i class="fa fa-remove"></i>Batal</button>
        </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        //ng.formProcess($("#ajaxFormActive"), 'active', location.href.split('#')[1]);
        var dtTable = $('#dt_completeNEW').DataTable();
        ng.formProcess($("#ajaxFormActive"), 'active', '');
        dtTable.ajax.reload( null, false );
        $('#ajaxFormA ctive').submit(function (e) {
            dtTable.ajax.reload( null, false );
        }); 
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        dtTable.ajax.reload( null, false );
        $('#ajaxFormResetPassword').submit(function (e) {
            dtTable.ajax.reload( null, false );
        });
    });
</script>
...
?>
<?php
if($form=='kirimaktivasi'){
?>
<form method="post" id="ajaxFormKirimAktivasi" action="index.php/ereg/admin_instansi/dokirimaktivasi">
        <input type="hidden" name="ID_USER" id="ID_USER" value="<?php echo $item->ID_USER; ?>">
        <div class="col-lg-12 text-center">
