                                                ...
                                                <tbody id="refup">
                                                    ...
                                                    foreach ($list_ver_pnwl as $row):
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><small><?= strtoupper($row->NAMA).' / <b>'.strtoupper($row->NAMA_TEMP).'</b>' ?></small></td>
                                                            ...
                                                            <td> 
                                                                ...
                                                                <button type="button" class="btn btn-sm btn-success btn-edit" href="index.php/ereg/All_ver_pn/popUpAdd/1/<?= $row->ID ?>/xl" title="Edit"><i class="fa fa-pencil"></i></button>
                                                                <button class="btn btn-sm btn-danger" onclick="cancelVerPN(<?= $row->ID ?>, 1)" data-toggle="tooltip" title="cancel"><i class="fa fa-close " style="color:white;"></i></button>
                                                            </td>
                                                        </tr>
                                                ...
                                                <tbody id="refadd">
                                                    ...
                                                    foreach ($list_ver_pnwl_tambah as $row):
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><small><?= '<b>' . $ket_dis . $strike . $row->NAMA_JABATAN . '</b> - ' . $row->NAMA_SUB_UNIT_KERJA . ' - ' . $row->NAMA_UNIT_KERJA ?></small></td>
                                                            <td> 
                                                                <button <?= $disable ?> class="btn btn-sm btn-info" onclick="savePenambahanPNWL(<?= $row->ID ?>)" data-toggle="tooltip" title="approve"><i class="fa fa-check"></i></button>
                                                                <button type="button" class="btn btn-sm btn-success btn-edit" href="index.php/ereg/All_ver_pn/popUpAdd/2/<?= $row->ID ?>/xl" title="Edit"><i class="fa fa-pencil"></i></button>
                                                                <button class="btn btn-sm btn-danger" data-toggle="tooltip" onclick="cancelVerPN(<?= $row->ID ?>, 2)" title="cancel"><i class="fa fa-close " style="color:white;"></i></button>
                                                            </td>
                                                        </tr>
                                                    ...
                                                    foreach ($list_non as $row):
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <button type="button" class="btn btn-sm btn-danger"  onclick="cancel_nonactxls(<?= $row->ID_PN . ',' . $row->ID_PN_JAB ?>)" title="Cancel Non Active "><i class="fa fa-repeat"></i></button>
    <!--                                                                <button type="button" class="btn btn-sm btn-primary btn-edit" href="index.php/ereg/All_ver_pn/popUpAdd/<?php echo $row->NIK; ?>" title="Edit"><i class="fa fa-pencil"></i></button>
