...
class User_kpk extends CI_Controller {
		...
		$data = array(
			...
			'breadcrumb'	=> call_user_func('ng::genBreadcrumb', 
								array(
									...
									'User KPK'  => 'index.php/'.strtolower(__CLASS__).'/'.strtolower(__FUNCTION__),
								)),
    ...
    function reset_password($id_user) {
        ...
        $this->muser->kirim_info_akun($data_user->EMAIL, $data_user->USERNAME, $password, 'Pemberitahuan Reset Password');
        redirect(site_url().'#index.php/user_pokja/');
    }
}
