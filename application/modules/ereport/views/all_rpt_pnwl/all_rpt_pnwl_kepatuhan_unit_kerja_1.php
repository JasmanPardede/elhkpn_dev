...
<div id="e-report-lhkpn">
	<section class="content-header">
		<h1>
			<i class="fa fa-list"></i> Kepatuhan Unit Kerja I
		</h1>
		<?=$breadcrumb?>
	</section>
	<section class="content">
		<div class="row">
			<div class="col-md-12">
				<div class="box">
					<div class="box-body">
					<form method="post" class='form-horizontal' id="ajaxFormCarikepatuhan" action="index.php/ereport/all_rpt_pnwl/kepatuhan_unit_kerja_1">
						...
						<hr>
						<h4 class="text-center"><strong>REKAPITULASI PENYAMPAIAN LHKPN <br> KOMISI PEMBERANTASAN KORUPSI (KPK) <br/> UNIT KERJA I</strong></h4>
							...
							<table id="dt_completeNEW" class="table table-striped table-bordered table-hover table-heading no-border-bottom">
								...
								<tbody>
									<?php 
										...
										if($list_data != false && $lembaga != NULL) { 
										$i=0;
