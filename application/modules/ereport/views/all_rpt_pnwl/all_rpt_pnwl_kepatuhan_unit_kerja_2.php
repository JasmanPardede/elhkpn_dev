...
<div id="e-report-lhkpn">
	<section class="content-header">
		<h1>
			<i class="fa fa-list"></i> Kepatuhan Unit Kerja II
		</h1>
		<?=$breadcrumb?>
	</section>
	<section class="content">
		<div class="row">
			<div class="col-md-12">
				<div class="box">
					<div class="box-body">
					<form method="post" class='form-horizontal' id="ajaxFormCarikepatuhan" action="index.php/ereport/all_rpt_pnwl/kepatuhan_unit_kerja_2">
							<div class="col-md-8 col-md-offset-2">
								<div class="form-group">
									<label class="col-md-4 control-label">Lembaga :</label>
									<div class="col-md-5">
						                <input type="text" required style="border:none;width:300px;" name="lembaga" placeholder="Lembaga" value="" id="lembaga">
									</div>
								</div>
								<div class="form-group">
									<label class="col-md-4 control-label">Unit Kerja :</label>
									<div class="col-md-5">
						                <input type="text" required style="border:none;width:300px;" name="unitkerja" placeholder="Unit Kerja" value="" id="unitkerja">
									</div>
								</div>
								<div class="form-group">
						...
						<hr>
						<h4 class="text-center"><strong>REKAPITULASI PENYAMPAIAN LHKPN <br> KOMISI PEMBERANTASAN KORUPSI (KPK) <br/> UNIT KERJA II</strong></h4>
							...
							<table id="dt_completeNEW" class="table table-striped table-bordered table-hover table-heading no-border-bottom">
								...
								<tbody>
									<?php 
										...
										$i++;
										$tot_sdh_lapor = ($row->lapor_lengkap + $row->lapor_tidak_lengkap + $row->belum_terverif);	
										...
										$total_belum_terverif += $row->belum_terverif;
									...
									echo '<tr>
										...
										<td class="tengah">'.($row->belum_terverif_0 + $row->belum_terverif_1).'</td>
										<td class="tengah">'.round($row->belum_terverif/$row->wajib_lapor_lhkpn, 2).' %</td>
...
<script type="text/javascript">
  ...
  //           ajax: {
  //               url: "<?=base_url('index.php/share/reff/getUnitKerja2')?>",
  //               dataType: 'json',
  //               quietMillis: 250,
  ...
  //               var id = $(element).val();
  //               if (id !== "") {
  //                   $.ajax("<?=base_url('index.php/share/reff/getUnitKerja2')?>/"+id, {
  //                       dataType: "json"
  ...
  //       });
		...
		//  $('#sub_unitkerja').select2({
		//  	// id = $('#lembaga').val();

  //           minimumInputLength: 0,
  //           ajax: {
  //               url: "<?php echo base_url('index.php/share/reff/getSubUnitKerja2')?>",
  //               dataType: 'json',
  //               quietMillis: 250,
  //               data: function (term, page) {
  ...
  //               var id = $(element).val();
  //               if (id !== "") {
  //                   $.ajax("<?php echo base_url('index.php/share/reff/getSubUnitKerja2')?>/"+id, {
  //                       dataType: "json"
  //                   }).done(function(data) { callback(data[0]); });
  //               }
  //           },
