	...
	<section class="content">
		<div class="row">
			<div class="col-md-12">
				<div class="box">
					<div class="box-body">
						<form method="post" class='form-horizontal' id="ajaxFormCarikepatuhan" action="index.php/ereport/all_rpt_pnwl/kepatuhan_per_bidang">
						...
						<hr>
						<h4 class="text-center"><strong>RINGKASAN PELAPORAN KEKAYAAN PENYELENGGARA NEGARA <br> NASIONAL PER BIDANG</strong></h4>
							...
							<table class="table table-striped table-bordered table-hover table-heading no-border-bottom">
								...
								<tbody>
									<?php 
										...
										// $pre_belum_terverif += round(($row->belum_terverif/$row->wajib_lapor_lhkpn)*100, 2);
