...
<div id="e-report-lhkpn">
	<section class="content-header">
		<h1>
			<i class="fa fa-list"></i> Kepatuhan BUMN
		</h1>
		<?=$breadcrumb?>
	</section>
	<section class="content">
		<div class="row">
			<div class="col-md-12">
				<div class="box">
					<div class="box-body">
					<form method="post" class='form-horizontal' id="ajaxFormCarikepatuhan" action="index.php/ereport/all_rpt_pnwl/kepatuhan_bumn">
						...
						<hr>
						<h4 class="text-center"><strong>RINGKASAN PELAPORAN KEKAYAAN PENYELENGGARA NEGARA <br> BUMN TINGKAT NASIONAL</strong></h4>
						<h5 class="text-center"><strong>Tahun Pelaporan : <?php echo $tahun; ?></strong></h5>
							<table class="table table-striped table-bordered table-hover table-heading no-border-bottom">
								...
								<tfoot style="background: #ABD8BD;">
									...
									<td class="tengah">'.$pre_belum_verif.' %</td>
