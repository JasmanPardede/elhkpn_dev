...
<div id="e-report-lhkpn">
	<section class="content-header">
		<h1>
			<i class="fa fa-list"></i> Kepatuhan Eksekutif Pusat
		</h1>
		<?=$breadcrumb?>
	</section>
	<section class="content">
		<div class="row">
			<div class="col-md-12">
				<div class="box">
					<div class="box-body">
					<form method="post" class='form-horizontal' id="ajaxFormCarikepatuhan" action="index.php/ereport/all_rpt_pnwl/kepatuhan_eksekutif_pusat">
						...
						<hr>
						<h4 class="text-center"><strong>RINGKASAN PELAPORAN KEKAYAAN PENYELENGGARA NEGARA <br> NASIONAL BIDANG EKSEKUTIF PUSAT</strong></h4>
