...
<div id="e-report-lhkpn">
	<section class="content-header">
		<h1>
			<i class="fa fa-list"></i> Kepatuhan Sudah Lapor
		</h1>
		<?=$breadcrumb?>
	</section>
	<section class="content">
		<div class="row">
			<div class="col-md-12">
				<div class="box">
				<div class="box-body">
				<form method="post" class='form-horizontal' id="ajaxFormCarikepatuhan" action="index.php/ereport/all_rpt_pnwl/kepatuhan_sudah_lapor">
						...
						<hr>
						<h4 class="text-center"><strong>REKAPITULASI PENYAMPAIAN LHKPN <br> KOMISI PEMBERANTASAN KORUPSI (KPK) <br/> SUDAH LAPOR</strong></h4>
