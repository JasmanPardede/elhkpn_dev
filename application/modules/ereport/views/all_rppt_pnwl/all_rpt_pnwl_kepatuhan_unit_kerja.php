<div id="e-report-lhkpn">
	<section class="content-header">
		<h1>
			<i class="fa fa-list"></i> Kepatuhan Per Unit Kerja
		</h1>
		<?=$breadcrumb?>
	</section>
	<section class="content">
		<div class="row">
			<div class="col-md-12">
				<div class="box">
					<div class="box-body">
						<form method="post" class='form-horizontal' id="ajaxFormCarikepatuhan" action="index.php/ereport/all_rpt_pnwl/kepatuhan_unit_kerja">
							<div class="col-md-8 col-md-offset-2">
								...
								<div class="form-group">
									...
									<div class="col-md-5">
										<input required value="<?php echo @$cari['INSTANSI'] ?>" readonly type="text" style="border:none; padding: 6px 0px; margin-bottom: 6px;" class="form-control input-sm" placeholder="Instansi" id="INSTANSI" name="CARI[INSTANSI]">
									</div>
								</div>
								<!-- sementara di hidden -->
						...
						?>
						<hr>
						<h4 class="text-center"><strong>KEPATUHAN PER UNIT KERJA</strong></h4>
						<table class="table no-border">
							<tbody>
								<tr>
									<td width="300px;">Instansi</td>
									<td width="10px;">:</td>
                                    <td>
                                        <?php echo (!empty($items)) ? $items[0]->INST_NAMA : '-' ; ?>
                                    </td>
								<tr>
									<td>Unit Kerja</td>
									<td>:</td>
							...
							<table class="table table-striped table-bordered table-hover table-heading no-border-bottom">
								...
								<tbody>
									<?php
										$TOTAL_WAJIBLAPORT = 0;
										$TOTAL_SUDAHLAPORT = 0;
										$TOTAL_SUDAH_UPDATE = 0;
										$TOTAL_PROSEN_SUDAH_UPDATE = 0;
										$TOTAL_BLM_UPDATE = 0;
										$TOTAL_PROSEN_SUDAH_UPDATE = 0;
									...
									<tr>
										...
										<td class="text-right"><?php echo $key->WAJIB_LAPOR==0?'?':'?'; ?></td>
										<td class="text-right"><?php echo $key->WAJIB_LAPOR==0?'?%':'?'; ?></td>
										<td class="text-right"><?php echo $key->WAJIB_LAPOR==0?'?':'?'; ?></td>
										<td class="text-right"><?php echo $key->WAJIB_LAPOR==0?'?':'?'; ?></td>
