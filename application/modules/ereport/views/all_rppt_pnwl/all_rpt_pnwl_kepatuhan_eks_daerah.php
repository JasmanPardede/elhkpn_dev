...
<div id="e-report-lhkpn">
	<section class="content-header">
		<h1>	
			<i class="fa fa-list"></i> Kepatuhan Eksekutif Daerah
		</h1>
		<?=$breadcrumb?>
	</section>
	<section class="content">
		<div class="row">
			<div class="col-md-12">
				<div class="box"><br/>
				<form method="post" class='form-horizontal' id="ajaxFormCarikepatuhan" action="index.php/ereport/all_rpt_pnwl/kepatuhan_eksekutif_daerah">
							<div class="col-md-8 col-md-offset-2">
								<div class="form-group">
									<label class="col-md-4 control-label">Provinsi :</label>
									<div class="col-md-5">
						                <input type="text" id="propinsi" style="border:none;width:300px;" name="provinsi" placeholder="provinsi" value="">
									</div>
								</div>
								<div class="form-group">
					...
					<div class="box-body">
						<hr>
						<h4 class="text-center"><strong>RINGKASAN PELAPORAN KEKAYAAN PENYELENGGARA NEGARA <br> NASIONAL BIDANG EKSEKUTIF DAERAH</strong></h4>
