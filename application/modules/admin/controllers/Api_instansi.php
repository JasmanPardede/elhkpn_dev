...
class Api_instansi extends MY_Controller {
    ...
    public function __construct() {
        ...
        $this->load->model('Mapi_instansi', '', TRUE);
    }
    ...
    public function index(){
        $data = array(
            'breadcrumb' => call_user_func('ng::genBreadcrumb', array(
                ...
                'API Instansi' => 'index.php/admin/api_instansi',
                'API' => 'index.php/admin/api_instansi',
            )),
        );
        $this->load->view('api_instansi_index', $data);
    }

    function load_data(){
        list($currentpage, $rowperpage, $keyword, $state_active, $sort) = $this->get_param_load_paging_default();
        $response = $this->Mapi_instansi->list_all($currentpage, $keyword, $rowperpage,true);
        $dtable_output = array(
    ...
    function add_form() {
        ...
        $this->load->view('api_instansi_form', $data);
    }
    ...
    function save_api(){
        ...
        $result = $this->Mapi_instansi->save_data($action);
        echo $result;
        return;
    }
    ...
    function approve_form($id) {
        ...
        $data = array(
            'form' => 'approve',
            'item' => $this->Mglobal->get_data_by_id('auth_api_instansi','id',$id,false,true),
            'roles' => $this->mrole->list_all()->result(),
            'instansis' => $this->minstansi->list_all()->result(),
        );
        $this->load->view('api_instansi_form', $data);
    ...
    function email_send(){
        ...
        $get_api = $this->Mglobal->get_data_by_id('auth_api_instansi','ID',$ID,false,true);
                            ...
                            <body>
                                ...
                                <div style="padding-left:1em">
                                    <table>
                                        ...
                                        <tr>
                                            <td>2.</td>
                                            <td>Undang-Undang Nomor 30 Tahun 2002 tentang Komisi Pemberantasan Tindak Pidana Korupsi, sebagaimana diubah dengan Undang-Undang Nomor 10 Tahun 2015 tentang Penetapan Peraturan Pemerintah Pengganti Undang-Undang Nomor 1 Tahun 2015 tentang Perubahan atas Undang-Undang Nomor 30 Tahun 2002 tentang Komisi Pemberantasan Korupsi menjadi Undang-Undang;</td>
                                        </td>
                                        <tr>
                                            <td>3.</td>
