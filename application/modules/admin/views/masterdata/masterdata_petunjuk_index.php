 ...
 * @package Views/masterdata/form_bantuan
*/
?>
<div class="box box-primary">
<div class="box-header with-border">
    <!--<button type="button" id="btnAddpetunjuk" class="btn btn-sm btn-primary"><i class="fa fa-plus"></i> Tambah Data</button>-->
    <div class="col-md-12">    
...
<!--  <div class="box-tools">
    ...
    <div class="input-group">
        <input type="text" class="form-control input-sm pull-right" style="width: 150px;" placeholder="Search Form Bantuan" name="CARI[TEXT]" value="<?php echo @$CARI['TEXT'];?>" id="CARI_TEXT"/>
...
<table id="dt_masterpetunjuk" class="table table-striped">
    <thead>
        <tr>
            <th width="30">No.</th>
            <th>Nama Petunjuk </th>
    ...
    <tbody>
        ...
        <tr>
            ...
            <!--d><?php echo str_ireplace(@$CARI['TEXT'], '<span style="border-bottom: 1px dashed #999;text-decoration: none;">'.@$CARI['TEXT'].'</span>', $item->NAME_FORM);?><span style="color:#0099FF;">aktif</span>':'<span style="color:#FF0000;">tidak aktif</span>');?></td-->
            <td width="120" nowrap="">
                ...
                <button type="button" class="btn btn-sm btn-success btnEditPetunjuk" title="Edit"><i class="fa fa-pencil"></i></button>
...
//            var key = $(self).parents('td').children('.key').val();
        ...
        var tblMasterPetunjuk = {
            tableId: 'dt_masterpetunjuk',
            reloadFn: {tableReload: true, tableCollectionName: 'tblMasterPetunjuk'},
            conf: {
                "bJQueryUI": true,
                "sPaginationType": "full_numbers",
                "bServerSide": true,
                "sAjaxSource": "<?php echo base_url('admin/masterdata/load_data_daftar_master_petunjuk/'); ?>",
                ...
                "aoColumns": [
                    ...
                    {"mDataProp": "PETUNJUK_NAME", bSearchable: true},
                    {"mDataProp": "PETUNJUK_TITLE", bSearchable: true},
                    {"mDataProp": "PETUNJUK_DESC", bSearchable: true},
                    {
                        "mDataProp": function (source, type, val) {

                            var BtnHapus = '<button type="button" class="btn btn-sm btn-danger btnDelete" onclick="fnDel(this, ' + source.ID + ');" title="Delete"><i class="fa fa-trash" ></i></button>';
                            var BtnEdit = '<button type="button" class="btn btn-sm btn-success btnEdit" onclick="fnEdit(this, ' + source.ID + ');" title="Edit"><i class="fa fa-pencil"></i></button>';
                            var BtnKembalikan = '<button style="display:'+stat+'" type="button" class="btn btn-sm btn-success btnEdit" onclick="fnKembalikan(this, ' + source.ID + ');" title="Kembalikan"><i class="fa fa-repeat"></i></button>';
        ...
        var gtblMasterPetunjuk;
        var clearPencarian = function () {
            $('#CARI_TEXT').val('');
            reloadTableDoubleTime(gtblMasterPetunjuk);
        };
        ...
        $(document).ready(function () {
            gtblMasterPetunjuk = initDtTbl(tblMasterPetunjuk);
        });
