...
<table id="dt_masterjenispelepasanharta" class="table table-striped table-bordered table-hover table-heading no-border-bottom">
    <thead>
        <tr>
            <th width="30">No.</th>
...
//            var key = $(self).parents('td').children('.key').val();
        ...
        var tblMasterJenisPelepasanHarta = {
            tableId: 'dt_masterjenispelepasanharta',
            reloadFn: {tableReload: true, tableCollectionName: 'tblMasterJenisPelepasanHarta'},
            conf: {
                "bJQueryUI": true,
                "sPaginationType": "full_numbers",
                "bServerSide": true,
                "sAjaxSource": "<?php echo base_url('admin/masterdata/load_data_daftar_master_jenispelepasanharta/'); ?>",
                ...
                "aoColumns": [
                    ...
                    {"mDataProp": "JENIS_PELEPASAN_HARTA", bSearchable: true},
                    {
        ...
        var gtblMasterJenisPelepasanHarta;
        var clearPencarian = function () {
            $('#CARI_TEXT').val('');
            reloadTableDoubleTime(gtblMasterJenisPelepasanHarta);
        };
        ...
        $(document).ready(function () {
            gtblMasterJenisPelepasanHarta = initDtTbl(tblMasterJenisPelepasanHarta);
        });
