...
<table id="dt_mastereselon" class="table table-striped">
    <thead>
        <tr>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td align="center"> <?php echo $item->KODE_ESELON; ?>
...
//            var key = $(self).parents('td').children('.key').val();
        ...
        var tblMasterEselon = {
            tableId: 'dt_mastereselon',
            reloadFn: {tableReload: true, tableCollectionName: 'tblMasterEselon'},
            conf: {
                "bJQueryUI": true,
                "sPaginationType": "full_numbers",
                "bServerSide": true,
                "sAjaxSource": "<?php echo base_url('admin/masterdata/load_data_daftar_master_eselon/'); ?>",
                ...
                "aoColumns": [
                    ...
                    {"mDataProp": "KODE_ESELON", bSearchable: true},
                    {"mDataProp": "ESELON", bSearchable: true},
                    {
                        "mDataProp": function (source, type, val) {

                            var BtnHapus = '<button type="button" class="btn btn-sm btn-danger btnDelete" onclick="fnDel(this, ' + source.ID_ESELON + ');" title="Delete"><i class="fa fa-trash" ></i></button>';
                            var BtnEdit = '<button type="button" class="btn btn-sm btn-success btnEdit" onclick="fnEdit(this, ' + source.ID_ESELON + ');" title="Edit"><i class="fa fa-pencil"></i></button>';
                            var BtnKembalikan = '<button style="display:'+stat+'" type="button" class="btn btn-sm btn-success btnEdit" onclick="fnKembalikan(this, ' + source.ID_ESELON + ');" title="Kembalikan"><i class="fa fa-repeat"></i></button>';
        ...
        var gtblMasterEselon;
        var clearPencarian = function () {
            $('#CARI_TEXT').val('');
            reloadTableDoubleTime(gtblMasterEselon);
        };
        ...
        $(document).ready(function () {
            gtblMasterEselon = initDtTbl(tblMasterEselon);
        });
