    ...
    <form method="post" id="ajaxFormAdd" action="<?php echo $urlSave;?>" enctype="multipart/form-data">
        <div class="box-body">
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <input type='text' class="form-control" name='NAMA_GOLONGAN' id='NAMA_GOLONGAN' value='' required>
                </div>
            </div>
        </div>
    ...
    <form method="post" id="ajaxFormEdit" action="<?php echo $urlSave;?>">
        <div class="box-body">
            <div class="form-group">
                <label class="col-sm-4 control-label">Golongan Harta <font color='red'>*</font>:</label>
                <div class="col-sm-8">
                    <input type='text' class="form-control" name='NAMA_GOLONGAN' id='NAMA_GOLONGAN' value='<?php echo $item->NAMA_GOLONGAN;?>' required>
                </div>
            </div>
        </div>
        <div class="pull-right">
            <input type="hidden" name="ID_GOLONGAN_HARTA" value="<?php echo $item->ID_GOLONGAN_HARTA;?>">
            <input type="hidden" name="act" value="<?php echo $act;?>">
            <button type="submit" class="btn btn-sm btn-primary"><i class="fa fa-save"></i> Simpan</button>
            <button type="button" class="btn btn-sm btn-danger" data-dismiss="modal"><i class="fa fa-close"></i> Batal</button>
        </div>
...
<div id="wrapperFormKembalikan" class="form-horizontal">
    Benarkah Akan Mengaktifkan kembali data Golongan Harta dibawah ini ?
...
<div id="wrapperFormDelete" class="form-horizontal">
    Benarkah Akan Menghapus Golongan Harta dibawah ini ?
