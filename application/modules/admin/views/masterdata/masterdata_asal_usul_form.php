    ...
    <form method="post" id="ajaxFormAdd" action="<?php echo $urlSave;?>" enctype="multipart/form-data">
        <div class="box-body">
            <div class="form-group">
                <label class="col-sm-4 control-label">Asal Usul <font color='red'>*</font>:</label>
                <div class="col-sm-8">
                    <input type='text' onkeyup="this.value = this.value.toUpperCase()" class="form-control" name='ASAL_USUL' id='ASAL_USUL' value='' required>
                </div>
            </div>
        </div>
    ...
    <form method="post" id="ajaxFormEdit" action="<?php echo $urlSave;?>">
        <div class="box-body">
            <div class="form-group">
                <label class="col-sm-4 control-label">Asal Usul <font color='red'>*</font>:</label>
                <div class="col-sm-8">
                    <input type='text' class="form-control" name='ASAL_USUL' id='ASAL_USUL' value='<?php echo $item->ASAL_USUL;?>' required>
                </div>
            </div>
        </div>
        <div class="pull-right">
            <input type="hidden" name="ID_ASAL_USUL" value="<?php echo $item->ID_ASAL_USUL;?>">
            <input type="hidden" name="act" value="<?php echo $act;?>">
            <button type="submit" class="btn btn-sm btn-primary"><i class="fa fa-save"></i> Simpan</button>
            <button type="button" class="btn btn-sm btn-danger" data-dismiss="modal"><i class="fa fa-close"></i> Batal</button>
        </div>
...
<div id="wrapperFormDelete" class="form-horizontal">
    Benarkah Akan Menghapus Asal Usul dibawah ini ?
    <form method="post" id="ajaxFormDelete" action="<?php echo $urlSave;?>">
        <div class="box-body">
            <div class="form-group">
                <label class="col-sm-4" style="text-align:right !important;">Asal Usul :</label>
                <label class="col-sm-8">
                    <?php echo $item->ASAL_USUL;?>
                </label>
            </div>
        </div>
        <div class="pull-right">
...
<div id="wrapperFormKembalikan" class="form-horizontal">
    Benarkah Akan Mengaktifkan kembali data Asal Usul Harta dibawah ini ?
    <form method="post" id="ajaxFormKembalikan" action="<?php echo $urlSave;?>">
        <div class="box-body">
            <div class="form-group">
                <label class="col-sm-4" style="text-align:right !important;">Asal Usul Harta :</label>
                <label class="col-sm-8">
                    <?php echo $item->ASAL_USUL;?>
                </label>
            </div>
