 ...
 * @package Views/masterdata/asalusul
*/
?>
...
<table id="dt_masterasalusul" class="table table-striped">
    <thead>
        <tr>
            <th width="30">No.</th>
            <th>Asal Usul</th>
...
//            var key = $(self).parents('td').children('.key').val();
        ...
        var tblMasterAsalUsul = {
            tableId: 'dt_masterasalusul',
            reloadFn: {tableReload: true, tableCollectionName: 'tblMasterAsalUsul'},
            conf: {
                "bJQueryUI": true,
                "sPaginationType": "full_numbers",
                "bServerSide": true,
                "sAjaxSource": "<?php echo base_url('admin/masterdata/load_data_daftar_master_asalusul/'); ?>",
                ...
                "aoColumns": [
                    ...
                    {"mDataProp": "ASAL_USUL", bSearchable: true},
                    {
                        "mDataProp": function (source, type, val) {
                            ...
                            var BtnHapus = '<button type="button" class="btn btn-sm btn-danger btnDelete" onclick="fnDel(this, ' + source.ID_ASAL_USUL + ');" title="Delete"><i class="fa fa-trash" ></i></button>';
                            var BtnEdit = '<button type="button" class="btn btn-sm btn-success btnEdit" onclick="fnEdit(this, ' + source.ID_ASAL_USUL + ');" title="Edit"><i class="fa fa-pencil"></i></button>';
                            var BtnKembalikan = '<button style="display:'+stat+'" type="button" class="btn btn-sm btn-success btnEdit" onclick="fnKembalikan(this, ' + source.ID_ASAL_USUL + ');" title="Kembalikan"><i class="fa fa-repeat"></i></button>';
        ...
        var gtblMasterAsalUsul;
        var clearPencarian = function () {
            $('#CARI_TEXT').val('');
            reloadTableDoubleTime(gtblMasterAsalUsul);
        };
        ...
        $(document).ready(function () {
            gtblMasterAsalUsul = initDtTbl(tblMasterAsalUsul);
        });
