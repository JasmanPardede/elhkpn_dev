...
<table id="dt_masterbantuan" class="table table-striped">
    <thead>
        <tr>
            <th width="30">No.</th>
            <th>Nama Label </th>
...
//            var key = $(self).parents('td').children('.key').val();
        ...
        var tblMasterBantuan = {
            tableId: 'dt_masterbantuan',
            reloadFn: {tableReload: true, tableCollectionName: 'tblMasterBantuan'},
            conf: {
                "bJQueryUI": true,
                "sPaginationType": "full_numbers",
                "bServerSide": true,
                "sAjaxSource": "<?php echo base_url('admin/masterdata/load_data_daftar_master_bantuan/'); ?>",
                ...
                "aoColumns": [
                    ...
                    {"mDataProp": "NAME_FORM", bSearchable: true},
                    {"mDataProp": "FORM_TITLE", bSearchable: true},
                    {"mDataProp": "FORM_DESC", bSearchable: true},
                    {"mDataProp": "FORM_HELP", bSearchable: true},
                    {"mDataProp": "FORM_TOOLTIP", bSearchable: true},
                    {
        ...
        var gtblMasterBantuan;
        var clearPencarian = function () {
            $('#CARI_TEXT').val('');
            reloadTableDoubleTime(gtblMasterBantuan);
        };
        ...
        $(document).ready(function () {
            gtblMasterBantuan = initDtTbl(tblMasterBantuan);
        });
