    ...
    <form method="post" id="ajaxFormAdd" action="<?php echo $urlSave;?>" enctype="multipart/form-data">
        <div class="box-body">
            <div class="form-group">
                <label class="col-sm-4 control-label">Pendidikan <font color='red'>*</font>:</label>
                <div class="col-sm-8">
    ...
    <form method="post" id="ajaxFormEdit" action="<?php echo $urlSave;?>">
        <div class="box-body">
            <div class="form-group">
                <label class="col-sm-4 control-label">Pendidikan <font color='red'>*</font>:</label>
                <div class="col-sm-8">
                    <input type='text' class="form-control" name='PENDIDIKAN' id='PENDIDIKAN' value='<?php echo $item->PENDIDIKAN;?>' required>
                </div>
            </div>
        </div>
        <div class="pull-right">
            <input type="hidden" name="ID_PENDIDIKAN" value="<?php echo $item->ID_PENDIDIKAN;?>">
            <input type="hidden" name="act" value="<?php echo $act;?>">
            <button type="submit" class="btn btn-sm btn-primary"><i class="fa fa-save"></i> Simpan</button>
            <button type="button" class="btn btn-sm btn-danger" data-dismiss="modal"><i class="fa fa-close"></i> Batal</button>
        </div>
...
<div id="wrapperFormDelete" class="form-horizontal">
    Benarkah Akan Menghapus Pendidikan dibawah ini ?
    <form method="post" id="ajaxFormDelete" action="<?php echo $urlSave;?>">
        <div class="box-body">
            <div class="form-group">
                <label class="col-sm-4" style="text-align:right !important;">Pendidikan :</label>
                <label class="col-sm-8">
                    <?php echo $item->PENDIDIKAN;?>
                </label>
            </div>
        </div>
        <div class="pull-right">
...
<div id="wrapperFormKembalikan" class="form-horizontal">
    Benarkah Akan Mengaktifkan kembali Pendidikan di bawah ini ?
