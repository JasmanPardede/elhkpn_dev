    ...
    <form method="post" id="ajaxFormAdd" action="<?php echo $urlSave;?>" enctype="multipart/form-data">
        <div class="box-body">
            <div class="form-group">
                <label class="col-sm-3 control-label">Golongan <span class="red-label">*</span>:</label>
                <div class="col-sm-5">
                    <select name="GOLONGAN" id="" class="form-control" >
                        <option value="">-Pilih Golongan-</option>
                    	<?php foreach ($glg as $glng): ?>
                    		<option value="<?= @$glng->ID_GOLONGAN_PENGELUARAN_KAS; ?>"><?= @$glng->NAMA_GOLONGAN; ?></option>
                    	<?php endforeach ?>
                    </select>
                </div>
            </div>
...
<div id="wrapperFormEdit" class="form-horizontal">
    <form method="post" id="ajaxFormEdit" action="<?php echo $urlSave;?>">
        <div class="box-body">
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <select name="GOLONGAN" id="" class="form-control" >
                    	<?php foreach ($glg as $glng): ?>
                    		<option <?= ($glng->ID_GOLONGAN_PENGELUARAN_KAS == $item->GOLONGAN ? 'selected' : ''); ?> value="<?= @$glng->ID_GOLONGAN_PENGELUARAN_KAS; ?>"><?= @$glng->NAMA_GOLONGAN; ?></option>
                    	<?php endforeach ?>
                    </select>
                </div>
            </div>
        ...
        <div class="pull-right">
            <input type="hidden" name="ID_JENIS_PENGELUARAN_KAS" value="<?php echo $item->ID_JENIS_PENGELUARAN_KAS;?>">
            <input type="hidden" name="act" value="<?php echo $act;?>">
            <button type="submit" class="btn btn-sm btn-primary"><i class="fa fa-save"></i> Simpan</button>
            <button type="button" class="btn btn-sm btn-danger" data-dismiss="modal"><i class="fa fa-close"></i> Batal</button>
        </div>
...
<div id="wrapperFormKembalikan" class="form-horizontal">
    Benarkah Akan Mengaktifkan kembali data Jenis Pengeluaran Kas dibawah ini ?
    <form method="post" id="ajaxFormKembalikan" action="<?php echo $urlSave;?>">
        <div class="box-body">
            <div class="form-group">
                <label class="col-sm-4" style="text-align:right !important;">Jenis Pengeluaran Kas :</label>
...
<div id="wrapperFormDelete" class="form-horizontal">
    Benarkah Akan Menghapus Jenis Pengeluaran Kas dibawah ini ?
