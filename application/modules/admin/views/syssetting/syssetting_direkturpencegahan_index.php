<div id="wrapperFormUpdateSetting" class="form-horizontal">
	<form method="post" id="ajaxFormUpdateSetting" action="index.php/admin/syssetting/save/direkturpencegahan">
		...
		<div class="form-group">
			<div class="pull-right col-sm-9">
				...
				<input type="hidden" name="SETTING" value="direkturpencegahan">
...
<script type="text/javascript">
	$(document).ready(function() {
		ng.formProcess($("#ajaxFormUpdateSetting"), 'insert', 'index.php/admin/syssetting/index/direkturpencegahan/', '');
