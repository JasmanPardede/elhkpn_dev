...
<!-- alert Penetapan -->
<div class="modal fade" id="alertPenetapanHtb" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (rs.result.LUAS_TANAH == 0 && rs.result.LUAS_BANGUNAN == 0){
                            ...
                            $("#alertPenetapanHtb .edit-action-alert").attr("id",id);
                            $('#alertPenetapanHtb').modal('toggle');
                        } else if (rs.result.ATAS_NAMA == null || rs.result.ATAS_NAMA == '') {
                            notif('Data Harta Tidak Bergerak gagal dimutakhirkan dengan status TETAP, dikarenakan Atas Nama bernilai kosong atau null, silakan direview kembali');
                            ...
                            notif('Data Harta Tidak Bergerak gagal dimutakhirkan dengan status TETAP, dikarenakan Nama Orang Lain / Lainnya bernilai kosong atau null, silakan direview kembali');
                        }else{
...
//                     $('#KET_PASANGAN_ANAK').val(rs.result.PASANGAN_ANAK);
        ...
        // EDIT ACTION ALERT
        $("#alertPenetapanHtb").on('click', '.edit-action-alert', function (event) {
            $('#alertPenetapanHtb').modal('toggle');
            var id = $(this).attr('id');
            $.ajax({
                url: base_url + 'portal/data_harta/edit_harta_tidak_begerak/' + id,
