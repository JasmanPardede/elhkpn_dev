...
<form role="form" enctype="multipart/form-data" name="submitdatapribadi" id="submitdatapribadi" method="POST" relaction="<?php echo base_url() . 'portal/data_pribadi/update'; ?>" action="javascript:void(0);">
    <div class="box-body row">
        ...
        <div class="col-lg-4">
            <div class="form-group group-0">
                <label id="LBL_NIP">NIP</label> <?= FormHelpPopOver('nip_pnwl'); ?>
                <input type="text" name="NIP" id="NIP" placeholder="Isikan NIP" class="form-control"  />
            </div>
            <div class="form-group group-0">
            ...
            <div class="form-group group-0">
                ...
                <div class="input-group date">
                    ...
                    <input type="text" name="TANGGAL_LAHIR" onkeydown="return false" autocomplete="off" irule="required" id="TANGGAL_LAHIR" placeholder="( tgl/bulan/tahun )" class="form-control"  />
                </div>
            </div>
