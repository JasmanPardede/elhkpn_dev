...
<div id="ModalHarta" class="modal fade container-fluid" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <form role="form" id="FormGerakLain">
                    ...
                    <div class="col-sm-6">
                       ...
                       <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="JUMLAH" id="JUMLAH" class="form-control money" required>   
                        </div>
						<div class="form-group">
                        ...
                        <div class="form-group form-tahun-perolehan">
                            <div class='input-group date' id='datetimepicker10'>
                                ...
                                <input type="text" name="TAHUN_PEROLEHAN_AWAL" id="TAHUN_PEROLEHAN_AWAL" class="form-control year"  onkeydown="return false" autocomplete="off"/>  
            ...
            <form role="form" id="formAsalUsul">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="besar_nilai_asal" id="besar_nilai_asal"  class="form-control input" required/>
                    </div>
                    <div class="form-group">
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $('#table-asal-usul').html('<tbody>'+list_asal_usul+'</tbody>');
         ...
         var list_jenis_harta = load_html('portal/data_harta/get_jenis_harta/3');
       ...
       $(".input").maskMoney({prefix:'', thousands:'.', decimal:',', allowZero:true,precision:0});
       
            
        $('#FormGerakLain').bootstrapValidator().on('error.form.bv', function(e, data) {
             AsalUsulValidation();
            ...
            if(error==0 && !asal_usul){
                ...
                var text;
                if(ID==''){
                    text = 'Data Harta Bergerak Lainnya berhasil ditambahkan';
                }else{
                    text = 'Data Harta Bergerak Lainnya berhasil diperbaharui';
                }
                if ((($('#status_harta').val() == '3' && $('#is_load_harta').val() == '1') || $('#status_harta').val() == '2' || $('#status_harta').val() == '1') && $('#is_pelepasan_harta').val() !== '1'){
                    if ($('#NILAI_PELAPORAN').val() == 0 || $('#NILAI_PELAPORAN').val() == '0'){
                        ...
                        do_submit('#FormGerakLain','portal/data_harta/update_harta_bergerak_lain',text,'#ModalHarta');
                    }
                ...
                $('#TableHbergerak').DataTable().ajax.reload(null,false);
            }
            return false;
         });
    ...
    $("#TAHUN_PEROLEHAN_AWAL").change(function() {
            CustomValidation();
     });
