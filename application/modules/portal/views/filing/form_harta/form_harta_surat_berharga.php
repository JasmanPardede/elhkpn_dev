...
<div id="ModalHarta" class="modal fade container-fluid" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <form role="form" id="FormSurat" enctype="multipart/form-data">
                ...
                <div class="modal-body row">
                    <div class="col-sm-4">
                        ...
                        <!-- <div class="form-group">
                             <label>Jenis File <span class="red-label">*</span></label> <?= FormHelpPopOver('jenis_file_sb'); ?>
                        ...
                        <!--<div class="form-group file1 form-file">-->
                        ...
                        <!--<div class="form-group file2">
                             <label class="control-label">Bukti Dokumen/Rekening <span class="red-label">*</span></label> <?= FormHelpPopOver('bukti_dokumen_sb'); ?>
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="NAMA_PENERBIT" id="NAMA_PENERBIT" class="form-control input_capital" required> 
                        </div>
                        <div class="form-group">
                        ...
                        <!-- /*ab menambahkan inputan tanggal -->
                            <div class="form-group form-tahun-perolehan">
                                ...
                                <input type="text" name="TAHUN_PEROLEHAN_AWAL" onkeydown="return false" id="TAHUN_PEROLEHAN_AWAL"  class="form-control year" autocomplete="off"  />  
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        var list_jenis_harta = load_html('portal/data_harta/get_jenis_harta/4');
...
//        });
        ...
        $('#FormSurat').bootstrapValidator({
            ...
            var text;
            if (ID == '') {
                text = 'Data Harta Surat Berharga berhasil ditambahkan';
            } else {
                text = 'Data Harta Surat Berharga berhasil diperbaharui';
            }
            if (ID == '') {
                if (error == 0 && !asal_usul && !notif_file) {
                    if ((($('#status_harta').val() == '3' && $('#is_load_harta').val() == '1') || $('#status_harta').val() == '2' || $('#status_harta').val() == '1') && $('#is_pelepasan_harta').val() !== '1'){
                        if ($('#NILAI_PELAPORAN').val() == 0 || $('#NILAI_PELAPORAN').val() == '0'){
                        	...
                        	do_submit('#FormSurat', 'portal/data_harta/update_surat_berharga', text, '#ModalHarta');
                        }
