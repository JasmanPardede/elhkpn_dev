...
class adLDAP {
    ...
    * @var string
    */   
	protected $_account_suffix = "@kpk.go.id";
    ...
    * @var string
    */
	protected $_base_dn = "DC=KPK,DC=GO,DC=ID"; 
    ...
    * @var array
    */
    protected $_domain_controllers = array('192.168.1.1','192.168.1.3');
    ...
    */
    public function all_users($include_desc = false, $search = "*", $sorted = true){
        if (!$this->_bind){ return (false); }
        //	(!(userAccountControl:1.2.840.113556.1.4.803:=2))<---- this for enable user only
        // Perform the search and grab all their details
        $filter = "(&(objectClass=user)(samaccounttype=". ADLDAP_NORMAL_ACCOUNT .")(objectCategory=person)(cn=".$search.") (!(userAccountControl:1.2.840.113556.1.4.803:=2)))";
